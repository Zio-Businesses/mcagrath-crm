<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">
        <?php echo app('translator')->get('modules.mollie.details'); ?>
    </h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'mollieDetails','class' => 'ajax-form','action' => ''.e(route('mollie_public', [$id, $company->hash])).'']); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.mollie.client_name'),'fieldName' => 'name','fieldId' => 'name','fieldPlaceholder' => __('modules.mollie.client_name'),'fieldValue' => '','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Email::resolve(['fieldLabel' => __('modules.mollie.client_email'),'fieldName' => 'email','fieldId' => 'email','fieldPlaceholder' => __('modules.mollie.client_email'),'fieldValue' => '','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-mollie-detail']); ?><?php echo app('translator')->get('app.save'); ?> <i class="fa fa-arrow-right pl-1"></i> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $('#save-mollie-detail').click(function () {
        var url = "<?php echo e(route('mollie_public', [$id, $company->hash])); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/public-payment/mollie/index.blade.php ENDPATH**/ ?>