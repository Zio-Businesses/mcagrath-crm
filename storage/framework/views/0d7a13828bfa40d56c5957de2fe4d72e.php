...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'editTicketGroup','class' => 'ajax-form']); ?>
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.tickets.groupName'),'fieldPlaceholder' => __('placeholders.tickets.ticketGroup'),'fieldRequired' => 'true','fieldName' => 'group_name','fieldValue' => $group->group_name,'fieldId' => 'group_name'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: "<?php echo e(route('ticket-groups.update', $group->id)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/ticket-settings/edit-group-modal.blade.php ENDPATH**/ ?>