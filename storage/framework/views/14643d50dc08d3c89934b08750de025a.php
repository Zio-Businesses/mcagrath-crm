...
<?php $component->withAttributes(['id' => 'import-client-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.importExcelClient'); ?></h4>
                <div class="row py-20">
                    <div class="col-md-12">
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/clients/ajax/import.blade.php ENDPATH**/ ?>