...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.payments.squareStatus'),'fieldName' => 'square_status','fieldId' => 'square_status','fieldValue' => 'active','checked' => $credentials->square_status == 'active'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="row <?php if($credentials->square_status == 'deactive'): ?> d-none <?php endif; ?>" id="square_details">
        <div class="col-lg-6">
            <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'square_environment','fieldLabel' => __('app.selectEnvironment'),'fieldName' => 'square_environment','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <option value="sandbox"
                        <?php if($credentials->square_environment == 'sandbox'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.sandbox'); ?></option>
                <option value="production"
                        <?php if($credentials->square_environment == 'production'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.production'); ?></option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('modules.payments.squareApplicationId'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <input type="password" name="square_application_id" id="square_application_id"
                       ...
                       value="<?php echo e($credentials->square_application_id); ?>" autocomplete="off">
...
<?php endif; ?>
        ...
        <div class="col-lg-6">
            <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('modules.payments.squareAccessToken'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                <input type="password" name="square_access_token" id="square_access_token"
                       class="form-control height-35 f-14"
                       value="<?php echo e($credentials->square_access_token); ?>" autocomplete="off">
                 <?php $__env->slot('preappend', null, []); ?> 
                    <button type="button" data-toggle="tooltip" data-original-title="<?php echo e(__('messages.viewKey')); ?>"
                            class="btn btn-outline-secondary border-grey height-35 toggle-password"><i
                            class="fa fa-eye"></i></button>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.payments.squareLocationId'),'fieldName' => 'square_location_id','fieldId' => 'square_location_id','fieldValue' => $credentials->square_location_id,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <p class="text-primary">(<?php echo app('translator')->get('messages.addSquareWebhookUrl'); ?>)</p>
        </div>
    </div>
</div>
<!-- Buttons Start -->
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 w-100','id' => 'save_square_data']); ?><?php echo app('translator')->get('app.save'); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/payment-gateway-settings/ajax/square.blade.php ENDPATH**/ ?>