...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('recurring-expenses.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 float-left openRightModal']); ?>
                        <?php echo app('translator')->get('modules.expensesRecurring.addExpense'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <script>
        ...
        $('body').on('change', '.change-expense-status', function() {
            ...
            if (typeof id !== 'undefined') {
                $.easyAjax({
                    url: "<?php echo e(route('recurring-expenses.change_status')); ?>",
                    type: "POST",
                    data: {
                        '_token': token,
                        expenseId: id,
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('recurring-expenses.destroy', ':id')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/recurring-expenses/index.blade.php ENDPATH**/ ?>