...
<?php endif; ?>
            ...
            <div class="btn-group" role="group" >
                ...
                <a href="<?php echo e(route('taskboards.index')); ?>" class="btn btn-secondary f-14" data-toggle="tooltip"
                    data-original-title="<?php echo app('translator')->get('modules.tasks.taskBoard'); ?>"><i class="side-icon bi bi-layout-three-columns"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/front/tasks/calendar.blade.php ENDPATH**/ ?>