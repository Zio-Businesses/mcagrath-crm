<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('Edit SOW'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addProjectSowForm']); ?>
    <div class="modal-body">
        <input type="hidden" name="project_id" value="<?php echo e($sow->project_id); ?>">
        <div class="row">
                    <div class="col-md-6">
                        
                        <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'sow_title','fieldLabel' => __('Enter sow title'),'fieldName' => 'sow_title','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                            <option value="">--</option>
                            <?php $__currentLoopData = $sow_title; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($sow->sow_title == $category->sow_title): echo 'selected'; endif; ?> value="<?php echo e($category->sow_title); ?>">
                                <?php echo e($category->sow_title); ?></option>
...
<?php endif; ?>
                    ...
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'category','fieldLabel' => __('Project Category'),'fieldName' => 'category','search' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Select::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($sow->category == $category->category_name): echo 'selected'; endif; ?> value="<?php echo e($category->category_name); ?>">
...
<?php $component->withAttributes([]); ?>
                            <select class="form-control select-picker" name="sub_category" id="sub_category"
                                ...
                                <option <?php if($sow->sub_category == $category->sub_category): echo 'selected'; endif; ?> value="<?php echo e($category->sub_category); ?>">
...
<?php $component->withAttributes([]); ?>
                                ...
                                <option <?php if($sow->contractor_type == $category->contractor_type): echo 'selected'; endif; ?> value="<?php echo e($category->contractor_type); ?>">
                                <?php echo e($category->contractor_type); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal67cd5dc9866c6185ad92d933c387fa86)): ?>
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('Description'),'fieldName' => 'description','fieldId' => 'description','fieldRequired' => 'true','fieldPlaceholder' => __('Enter sow description'),'fieldValue' => $sow->description] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-sow-milestone']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
$(document).ready(function() {
    ...
    $('#save-sow-milestone').click(function() {
        var url = "<?php echo e(route('sow.update', $sow->id)); ?>";
        $.easyAjax({
            url: url,
...
<?php /**PATH C:\xampp\htdocs\public_html\resources\views/projects/sow/edit.blade.php ENDPATH**/ ?>