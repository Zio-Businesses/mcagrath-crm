...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.title'),'fieldName' => 'heading','fieldRequired' => 'true','fieldId' => 'heading','fieldPlaceholder' => __('placeholders.task')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                            ...
                            <option selected value="medium"><?php echo app('translator')->get('modules.tasks.medium'); ?></option>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-task-form').click(function() {
            ...
            const url = "<?php echo e(route('project-template-task.store')); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/project-templates/task/ajax/create.blade.php ENDPATH**/ ?>