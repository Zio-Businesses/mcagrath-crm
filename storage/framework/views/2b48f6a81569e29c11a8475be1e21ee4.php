...
<?php $component->withAttributes([]); ?>
                        <select class="form-control multiple-users" multiple name="group_id[]" data-live-search="true"
                            ...
                            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                    data-content="<span class='badge badge-pill badge-light border p-2'><?php echo e($group->team_name); ?></span>"
                                    value="<?php echo e($group->id); ?>"><?php echo e($group->team_name); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-project-member').click(function() {
        var url = "<?php echo e(route('project-template-member.store')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('#save-project-department').click(function() {
        var url = "<?php echo e(route('project_template_members.store_group')); ?>";
        $.easyAjax({
            url: url,
            container: '#addProjectMemberForm',
            blockUI: true,
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\project-templates\project-member\create.blade.php ENDPATH**/ ?>