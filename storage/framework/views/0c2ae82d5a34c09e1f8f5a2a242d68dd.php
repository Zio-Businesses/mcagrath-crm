    ...
    <div id="container">
        ...
        <div class="right-invoice">
            ...
            <section id="invoice-title-number">
                ...
                <div class="title-top">
                    <span  class="description"><?php echo app('translator')->get('app.issuesDate'); ?>:</span>
                    <span  class="description"><?php echo e($creditNote->issue_date->translatedFormat(company()->date_format)); ?></span>
                </div>

                <div id="title description"><?php echo e($creditNote->cn_number); ?></div>
            ...
            <?php if(!is_null($creditNote->project) && !is_null($creditNote->project->client)): ?>
                <section id="client-info">
                    ...
                    <div class="client-name description">
                        <strong><?php echo e($creditNote->project->client->name_salutation); ?></strong>
                    </div>
            ...
            <?php elseif(is_null($creditNote->project) && !is_null($creditNote->client) && !is_null($creditNote->client->clientDetails)): ?>
                <section id="client-info">
                    <span><?php echo app('translator')->get('modules.credit-notes.billedTo'); ?>:</span>
                    <div class="client-name description">
                        <strong><?php echo e($creditNote->client->name_salutation); ?></strong>
                    </div>
            ...
            <section id="items">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th><?php echo app('translator')->get('modules.credit-notes.unitPrice'); ?> (<?php echo htmlentities($creditNote->currency->currency_code); ?>)</th>
                    ...
                    <?php $__currentLoopData = $creditNote->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($item->type == 'item'): ?>
                            <tr data-iterate="item">
                                <td style="text-align: right;"><?php echo e(++$count); ?></td>
                                <!-- Don't remove this column as it's needed for the row commands -->
                                <td class="word-break">
                                    <?php echo e($item->item_name); ?>

                                    <?php if(!is_null($item->item_summary)): ?>
                                        <p class="item-summary description word-break"><?php echo nl2br(pdfStripTags($item->item_summary)); ?></p>
                                    <?php endif; ?>
                                    <?php if($item->creditNoteItemImage): ?>
                                        <p class="mt-2">
                                            <img src="<?php echo e($item->creditNoteItemImage->file_url); ?>" width="80"
                                ...
                                <td style="text-align: right;"><?php echo e($item->quantity); ?><?php if($item->unit): ?><br><span class="f-11 text-dark-grey"><?php echo e($item->unit->unit_type); ?></span><?php endif; ?></td>
            ...
            <section id="sums">
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td><?php echo e(number_format((float) $creditNote->sub_total, 2, '.', '')); ?></td>
                    </tr>
                    <?php if($discount != 0 && $discount != ''): ?>
                        <tr data-iterate="tax">
                            <th><?php echo app('translator')->get('modules.credit-note.discount'); ?>:</th>
                            <td>-<?php echo e(number_format((float) $discount, 2, '.', '')); ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-iterate="tax">
                            ...
                            <td><?php echo e(number_format((float) $tax, 2, '.', '')); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr class="amount-total">
                        <th><?php echo app('translator')->get('modules.invoices.total'); ?>:</th>
                        <td><?php echo e(number_format((float) $creditNote->total, 2, '.', '')); ?></td>
                    </tr>
                    <tr>
                        <th>
                            <?php echo app('translator')->get('modules.credit-notes.creditAmountUsed'); ?>:</th>
                        <td>
                            <?php echo e(number_format((float) $creditNote->creditAmountUsed(), 2, '.', '')); ?></td>
                    </tr>
                    <tr>
                        <th>
                            <?php echo app('translator')->get('app.adjustmentAmount'); ?> :</th>
                        <td>
                            <?php echo e(number_format((float) $creditNote->adjustment_amount, 2, '.', '')); ?></td>
                    </tr>
                    <tr>
                        <th>
                            <?php echo app('translator')->get('modules.credit-notes.creditAmountRemaining'); ?>:</th>
                        <td>
                            <?php echo e(number_format((float) $creditNote->creditAmountRemaining(), 2, '.', '')); ?></td>
                    </tr>
                </table>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/credit-notes/pdf/invoice-4.blade.php ENDPATH**/ ?>