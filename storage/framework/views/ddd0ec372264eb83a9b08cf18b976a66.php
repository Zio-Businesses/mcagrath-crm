<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.addShippingAddress'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'shipping-address-form']); ?>
...
<script>
    ...
    $('#save-shipping-address').click(function() {
        ...
        let url = "<?php echo e(route('invoices.add_shipping_address', [':id'])); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/invoices/add_shipping_address.blade.php ENDPATH**/ ?>