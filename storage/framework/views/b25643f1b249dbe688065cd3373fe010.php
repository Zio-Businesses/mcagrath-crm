...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'update-appreciation-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('modules.appreciations.editAppreciation'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'appreciation_type','fieldLabel' => __('modules.appreciations.appreciationType')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                    ...
                                    <select class="form-control select-picker" name="award" id="appreciation_type"
                                        ...
                                        <?php $__currentLoopData = $appreciationTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appreciationType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if($appreciation->award_id == $appreciationType->id): ?> selected <?php endif; ?>  data-content="<i class='bi bi-<?php echo e($appreciationType->awardIcon->icon); ?>' style='color: <?php echo e($appreciationType->color_code); ?>'></i> <?php echo e($appreciationType->title); ?>" value="<?php echo e($appreciationType->id); ?>">
                                                <?php echo e($appreciationType->title); ?> <?php echo e($appreciationType->id); ?>
...
<?php $component = App\View\Components\UserOption::resolve(['user' => $employee,'selected' => ($appreciation->award_to == $employee->id)] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.date'),'fieldName' => 'award_date','fieldId' => 'award_date','fieldPlaceholder' => __('app.awardDate'),'fieldValue' => $appreciation->award_date->translatedFormat(company()->date_format)] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginal89b295b0763c93abe0143426334eb5d6); ?>
<?php endif; ?>
                                    <div id="summery"><?php echo $appreciation->summary; ?></div>
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg bmp','fieldLabel' => __('modules.appreciations.photo'),'fieldName' => 'photo','fieldId' => 'photo','fieldValue' => ($appreciation->image ? $appreciation->image_url : ''),'fieldHeight' => '119','popover' => __('messages.appreciationPhoto')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'update-appreciation','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#update-appreciation').click(function() {
            const url = "<?php echo e(route('appreciations.update', $appreciation->id)); ?>";
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\appreciations\ajax\edit.blade.php ENDPATH**/ ?>