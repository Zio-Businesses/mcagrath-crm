                        ...
                        <div class="select-others height-35 rounded">
                            <select class="form-control select-picker" data-live-search="true" data-size="8"
                                ...
                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option  <?php if($item->id == $estimate->project_id): echo 'selected'; endif; ?> value="<?php echo e($item->id); ?>"><?php echo e($item->project_short_code); ?></option>
...
<?php endif; ?>
                    <div class="select-others height-35 rounded">
                        <select class="form-control select-picker" data-live-search="true" data-size="8"
                            ...
                            <option value="">--</option>
                            <?php $__currentLoopData = $estimate->project->projectvendor->unique('vendor_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($estimate->vendor_id == $item->vendor_id): ?> selected <?php endif; ?> value="<?php echo e($item->vendor_id); ?>">
                                    <?php echo e($item->vendor_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                            ...
                            <tr>
                                <td class="border-bottom-0 btrr-mbl btlr">
                                    <input type="text" class="f-14 border-0 w-100 item_name form-control"
                                        name="item_name[]" placeholder="<?php echo app('translator')->get('modules.expenses.itemName'); ?>" value="<?php echo e($item->item_name); ?>">
                                </td>
                                                    ...
                                                    <tr>
                                                        <td width="70%" class="c-inv-sub-padding">
                                                            <input type="number" min="0"
                                                                ...
                                                                placeholder="0"
                                                                value="<?php echo e($estimate->discount); ?>">
                                                                </td>
...
<script>
    $(document).ready(function() {
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "<?php echo e(route('vendor-estimates.update', $estimate->id)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/estimates-vendor/ajax/edit.blade.php ENDPATH**/ ?>