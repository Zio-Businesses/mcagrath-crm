    ...
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        ...
        <div class="d-flex justify-content-between action-bar">
            <div id="table-actions" class="d-flex align-items-center">
                <?php if($addDealNotePermission == 'all' || $addDealNotePermission == 'added' || $addDealNotePermission == 'both'): ?>
...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('deal-notes.create').'?lead='.$deal->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('body').on('click', '.delete-table-row-lead', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "<?php echo e(route('deal-notes.destroy', ':id')); ?>";
    ...
    const applyQuickAction = () => {
        ...
        var url = "<?php echo e(route('deal-notes.apply_quick_action')); ?>?row_ids=" + rowdIds;
    ...
    var getNoteDetail = function(id) {
        ...
        var url = "<?php echo e(route('deal-notes.show', ':id')); ?>";
        url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/leads/ajax/notes.blade.php ENDPATH**/ ?>