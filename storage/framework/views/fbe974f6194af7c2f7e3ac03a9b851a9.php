...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 openRightModal float-left','data-redirect-url' => ''.e(route('designation.hierarchy')).'']); ?>
...
<?php endif; ?>
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="<?php echo e(route('designations.index')); ?>" class="btn btn-secondary f-14" data-toggle="tooltip"
                data-original-title="<?php echo app('translator')->get('modules.leaves.tableView'); ?>"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="<?php echo e(route('designation.hierarchy')); ?>" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
            ...
            <div class="col-12 chart-section">
                <div class="row">
                    <div class="col-md-6" id="chartTree">
                        <?php echo $__env->make('designations-hierarchy.chart_tree', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                    <div class="col-md-6" id="chartOrganization">
                        <?php echo $__env->make('designations-hierarchy.chart_organization', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
$('#search-text-field').on('change keyup',
 ...
 function searchText(){
        ...
        $.ajax({
            url: "<?php echo e(route('designation.srchFilter')); ?>",
            type: "POST",
            data: {
                ...
                if (parent_id == 'NewNode') {
                    var checkExits = setInterval(() => {
                        if ($('#node-ul-NewNode').length) {
                            ...
                            $.ajax({
                                url: "<?php echo e(route('designation.changeParent')); ?>",
                                type: "POST",
                                data: {
                                    "_token": "<?php echo e(csrf_token()); ?>",
                                    "newParent": $newParent,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/designations-hierarchy/index.blade.php ENDPATH**/ ?>