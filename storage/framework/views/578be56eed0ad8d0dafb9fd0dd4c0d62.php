    ...
    <div id="container">
        <div class="invoice-top">
            ...
            <section id="invoice-info"  class="description">
                <table>
                    <tr>
                        <td><?php echo app('translator')->get('modules.invoices.invoiceDate'); ?>:</td>
                        <td><?php echo e($invoice->issue_date->translatedFormat($company->date_format)); ?></td>
                    </tr>
                    <?php if(empty($invoice->order_id) && $invoice->status === 'unpaid' && $invoice->due_date->year > 1): ?>
                        <tr>
                            <td><?php echo app('translator')->get('app.dueDate'); ?>:</td>
                            <td><?php echo e($invoice->due_date->translatedFormat($company->date_format)); ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php if($invoiceSetting->show_status): ?>
                    <tr>
                        <td><?php echo app('translator')->get('app.status'); ?>:</td>
                        <td><?php echo app('translator')->get('modules.invoices.' . $invoice->status); ?></td>
                    </tr>
                    <?php endif; ?>
                    <?php if($creditNote): ?>
                        <tr>
                            <td><?php echo app('translator')->get('app.credit-note'); ?></td>
                            <td><?php echo e($creditNote->cn_number); ?></td>
                        </tr>
                    <?php endif; ?>
                ...
                <section id="invoice-title-number">
                    ...
                    <span id="number"><?php echo e($invoice->invoice_number); ?></span>
        ...
        <div class="invoice-body">
            <section id="items"  class="description">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <?php echo e(currency_format($invoice->getPaidAmount(), $invoice->currency_id, false)); ?>
            ...
            <section id="terms">
                <?php if($invoice->note): ?>
                    <div class="word-break item-summary description"><b><?php echo app('translator')->get('app.note'); ?></b><br><?php echo nl2br($invoice->note); ?></div>
                <?php endif; ?>
                <div class="word-break item-summary description"><b><?php echo app('translator')->get('modules.invoiceSettings.invoiceTerms'); ?></b><br><?php echo nl2br($invoiceSetting->invoice_terms); ?></div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php echo e($payment->paid_on->translatedFormat($company->date_format)); ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/invoices/pdf/invoice-2.blade.php ENDPATH**/ ?>