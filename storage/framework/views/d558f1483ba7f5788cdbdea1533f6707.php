...
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($currency->id == company()->currency_id): ?> selected <?php endif; ?> value="<?php echo e($currency->id); ?>" data-currency-name="<?php echo e($currency->currency_name); ?>">
...
<?php $component->withAttributes([]); ?>
                                ...
                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option data-currency-id="<?php echo e($project->currency_id); ?>" <?php if($projectId == $project->id): ?> selected <?php endif; ?> value="<?php echo e($project->id); ?>">
...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.expensesRecurring.immediateExpense'),'fieldName' => 'immediate_expense','fieldId' => 'immediate_expense','fieldValue' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4 mt-0">
                                <?php if (isset($component)) { $__componentOriginal1fded940a0a5d34bf1b88a1f45916593 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1fded940a0a5d34bf1b88a1f45916593 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Number::resolve(['fieldLabel' => __('modules.invoices.totalCount'),'fieldName' => 'billing_cycle','fieldId' => 'billing_cycle','fieldHelp' => __('modules.invoices.noOfBillingCycle')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.number'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Number::class))->getConstructor()): ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-4 mt-4 information-box">
                        <p id="plan"><?php echo app('translator')->get('app.expenseGeneratedDaily'); ?></p>
                        <p id="current_date"><?php echo app('translator')->get('modules.expensesRecurring.currentExpenseDate'); ?> <?php echo e(now()->translatedFormat(company()->date_format)); ?></p>
                        <p id="next_date"><?php echo app('translator')->get('modules.expensesRecurring.nextExpenseDate'); ?> <?php echo e(now()->addDay()->translatedFormat(company()->date_format)); ?></p>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-expense-form').click(function() {
            const url = "<?php echo e(route('recurring-expenses.store')); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/recurring-expenses/ajax/create.blade.php ENDPATH**/ ?>