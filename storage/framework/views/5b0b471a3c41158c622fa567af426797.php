                    ...
                    <?php if($viewTaskFilePermission == 'all' || ($viewTaskFilePermission == 'added' && $file->added_by == user()->id)): ?>
                        <?php if($file->icon != 'images'): ?>
                            <a class="cursor-pointer d-block text-dark-grey f-13 pt-3 px-3 " target="_blank"
                                href="<?php echo e(route('task-files.show', md5($file->id))); ?>"><?php echo app('translator')->get('app.view'); ?></a>
                        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/front/tasks/files/show.blade.php ENDPATH**/ ?>