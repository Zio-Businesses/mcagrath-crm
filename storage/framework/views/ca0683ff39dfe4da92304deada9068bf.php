...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'saveLeadConsentForm','class' => 'form-horizontal']); ?>
        <input type="hidden" name="consent_id" value="<?php echo e($consentId); ?>">
        <input type="hidden" name="status" value="<?php if($consent->lead && $consent->lead->status == 'agree'): ?> disagree <?php else: ?> agree <?php endif; ?>">
        <div class="row">
            <div class="col-md-12">
...
<?php endif; ?>
            ...
            <?php if(($consent->lead && $consent->lead->status == 'disagree') || !$consent->lead): ?>
                <div class="col-md-12">
                        <?php if (isset($component)) { $__componentOriginal2f60389a9e230471cd863683376c182f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2f60389a9e230471cd863683376c182f = $attributes; } ?>
...
<?php endif; ?>
    ...
    <?php if($consent->lead && $consent->lead->status == 'agree'): ?>
...
<script>
    $(document).on('click', '#save-consent', function(){
        $.easyAjax({
            url: "<?php echo e(route('deals.save_lead_consent', $leadId)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/leads/gdpr/consent-form.blade.php ENDPATH**/ ?>