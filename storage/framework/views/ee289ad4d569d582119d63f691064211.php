...
<?php $component->withAttributes(['id' => 'add-lead-category','class' => 'ajax-form']); ?>
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.lead.editDealCategory'); ?></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'category_name','fieldLabel' => __('modules.projectCategory.categoryName'),'fieldName' => 'category_name','fieldRequired' => 'true','fieldValue' => $category->category_name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('#save-category').click(function() {
        $.easyAjax({
            url: "<?php echo e(route('leadCategory.update', $category->id)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/lead-settings/edit-category-modal.blade.php ENDPATH**/ ?>