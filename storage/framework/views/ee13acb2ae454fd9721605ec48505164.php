...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'editVendorFilterForm']); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('Filter Name'),'fieldName' => 'filter_name','fieldRequired' => 'true','fieldId' => 'filter_name_edit','fieldValue' => $filter->name,'fieldPlaceholder' => __('Enter filter name')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
$(document).ready(function() {
    ...
    $('#edit-filter').click(function () {
        ...
        var url = "<?php echo e(route('vendor-filter.update',$filter->id)); ?>";
        $.easyAjax({
            url: url,
...
});<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendors/edit-filter.blade.php ENDPATH**/ ?>