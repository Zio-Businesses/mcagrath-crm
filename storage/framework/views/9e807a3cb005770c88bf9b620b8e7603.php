...
<div id="container">
    ...
    <section id="invoice-title-number description">
        ...
        <span id="title"><?php echo e($estimate->estimate_number); ?> <?php echo e($invoiceSetting->locale); ?></span>
    ...
    <section id="client-info" class="description">
        <?php if(
            ...
            <?php if($estimate->client && $estimate->client->name && $invoiceSetting->show_client_name == 'yes'): ?>
                <div>
                    <span class="bold description"><?php echo e($estimate->client->name_salutation); ?></span>
                </div>
            <?php endif; ?>

            <?php if($estimate->client && $estimate->client->email && $invoiceSetting->show_client_email == 'yes'): ?>
                <div>
                    <span class="description"><?php echo e($estimate->client->email); ?></span>
                </div>
            <?php endif; ?>
            ...
            <?php $__currentLoopData = $estimate->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($item->type == 'item'): ?>
                    <tr data-iterate="item">
                        ...
                        <td>
                            <div class="mb-3"><?php echo e($item->item_name); ?></div>
                            <?php if(!is_null($item->item_summary)): ?>
                                <p class="item-summary mb-3"><?php echo nl2br(pdfStripTags($item->item_summary)); ?></p>
                            <?php endif; ?>
                            <?php if($item->estimateItemImage): ?>
                                <p class="mt-2">
                                    <img src="<?php echo e($item->estimateItemImage->file_url); ?>" width="60"
    ...
    <section id="sums" class="description">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="amount-total">
                ...
                <td><?php echo e(currency_format($estimate->total, $estimate->currency_id, false)); ?> <?php echo htmlentities($estimate->currency->currency_code); ?>
    ...
    <section id="terms" class="description">
        <div class="notes description">
            <div>
                ...
                <span><?php echo e($estimate->valid_till ? $estimate->valid_till->translatedFormat($company->date_format) : '--'); ?></span>
            </div>
            <?php if($estimate->status == 'unpaid'): ?>
                <div>
                    <span><?php echo app('translator')->get('app.dueDate'); ?>:</span>
                    <span><?php echo e($estimate->due_date->translatedFormat($company->date_format)); ?></span>
                </div>
            <?php endif; ?>
            <div>
            ...
            <?php if($estimate->note): ?>
                <br> <?php echo app('translator')->get('app.note'); ?> : <br><?php echo nl2br($estimate->note); ?> <br>
            <?php endif; ?>
            <br><?php echo app('translator')->get('modules.invoiceSettings.invoiceTerms'); ?> <br><?php echo nl2br($invoiceSetting->invoice_terms); ?><br>
            <br>
            <?php if(isset($invoiceSetting->other_info)): ?>
                <?php echo nl2br($invoiceSetting->other_info); ?><br>
            <?php endif; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/estimates/pdf/invoice-3.blade.php ENDPATH**/ ?>