...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('expenses.show', $notification->data['id']),'image' => $notificationUser->image_url,'title' => __('email.expenseRecurringStatus.subject'),'text' => $notification->data['item_name'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/expense_recurring_status.blade.php ENDPATH**/ ?>