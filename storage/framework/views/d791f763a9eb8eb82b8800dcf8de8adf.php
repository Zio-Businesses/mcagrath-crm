<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.updateRenewContract'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'edit-renew-data-form']); ?>
        <div class="row">
...
<?php $component = App\View\Components\Forms\Datepicker::resolve(['fieldId' => 'renew_start_date','fieldRequired' => 'true','fieldLabel' => __('modules.projects.startDate'),'fieldName' => 'start_date','fieldValue' => $renew->start_date->timezone(company()->timezone)->format(company()->date_format),'fieldPlaceholder' => __('placeholders.date')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div class="col-md-6 col-lg-4">
                <?php if (isset($component)) { $__componentOriginalf704f069031d81dfb7cf95f6709a6a66 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf704f069031d81dfb7cf95f6709a6a66 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Datepicker::resolve(['fieldId' => 'renew_end_date','fieldValue' => (($renew->end_date==null) ? $renew->end_date : $renew->end_date->timezone(company()->timezone)->format(company()->date_format)),'fieldLabel' => __('modules.timeLogs.endDate'),'fieldName' => 'end_date','fieldPlaceholder' => __('placeholders.date')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.datepicker'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Datepicker::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'amount','fieldLabel' => __('modules.contracts.contractValue'),'popover' => __('modules.contracts.setZero')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                     <?php $__env->slot('append', null, []); ?> 
                        <span
                            class="input-group-text height-35 border bg-white"><?php echo e(company()->currency->currency_code); ?></span>
                     <?php $__env->endSlot(); ?>

                    <input type="number" min="0" name="amount" value="<?php echo e($renew->amount ?? ''); ?>"
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-edit-renew']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        const dp3 = datepicker('#renew_start_date', {
            position: 'bl',
            dateSelected: new Date("<?php echo e(str_replace('-', '/', $renew->start_date)); ?>"),
        ...
        const dp4 = datepicker('#renew_end_date', {
            position: 'bl',
            dateSelected: new Date("<?php echo e($renew->end_date ? str_replace('-', '/', $renew->end_date) : str_replace('-', '/', now())); ?>"),
            onSelect: (instance, date) => {
                dp3.setMax(date);
            },
            ...datepickerConfig
        ...
        $('#save-edit-renew').click(function() {
            ...
            const url = "<?php echo e(route('contract-renew.update', $renew->id)); ?>";
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\contracts\renew\edit.blade.php ENDPATH**/ ?>