...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('vendor-module-notes.create').'?vendorid='.$vendorDetail->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
        $('#vendor-module-note-table').on('preXhr.dt', function(e, settings, data) {
            var vendorID = "<?php echo e($vendorDetail->id); ?>";
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "<?php echo e(route('vendor-module-notes.destroy', ':id')); ?>";
...
<?php /**PATH C:\xampp\htdocs\public_html\resources\views/vendors/ajax/notes.blade.php ENDPATH**/ ?>