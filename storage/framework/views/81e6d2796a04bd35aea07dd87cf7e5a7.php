    ...
    <main>
        <div id="details" class="clearfix">
            ...
            <div id="invoice">
                ...
                <?php endif; ?>
                <div class="date"><?php echo app('translator')->get('app.menu.issuesDate'); ?>:
        ...
        <p id="notes">
            ...
            <?php endif; ?>
            <?php if($invoice->status == 'unpaid'): ?>
                <?php echo app('translator')->get('modules.invoiceSettings.invoiceTerms'); ?>
                <br>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/credit-notes/pdf/invoice-recurring.blade.php ENDPATH**/ ?>