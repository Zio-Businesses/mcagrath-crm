<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">
        <?php echo app('translator')->get('modules.paystack.details'); ?>
    </h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'paystackDetails','class' => 'ajax-form','action' => ''.e(route('paystack_public', [$id, $company->hash])).'']); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.paystack.client_name'),'fieldName' => 'name','fieldId' => 'name','fieldPlaceholder' => __('modules.paystack.client_name'),'fieldValue' => '','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Email::resolve(['fieldLabel' => __('modules.paystack.client_email'),'fieldName' => 'email','fieldId' => 'email','fieldPlaceholder' => __('modules.paystack.client_email'),'fieldValue' => '','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-paystack-detail']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-paystack-detail').click(function () {
        ...
        var url = "<?php echo e(route('paystack_public',[ $id, $company->hash])); ?>";
        $.easyAjax({
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/public-payment/paystack/index.blade.php ENDPATH**/ ?>