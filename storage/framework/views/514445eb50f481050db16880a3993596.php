...
<?php $component->withAttributes([]); ?>
                    <?php $__currentLoopData = $allBoardColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($column->priority == $firstPriority): ?>
                            <option value="<?php echo e($column->priority); ?>" priority-type="before">Before <?php echo e($column->column_name); ?></option>
                            <option value="<?php echo e($column->priority); ?>" >After <?php echo e($column->column_name); ?></option>
                        <?php else: ?>
                            <option value="<?php echo e($column->priority); ?>" >After <?php echo e($column->column_name); ?></option>
                        <?php endif; ?>
...
<script>
    ...
    $('#save-board-column').click(function() {
        ...
        if(priorityType == "before"){
            var url = "<?php echo e(route('taskboards.store')); ?>?before";
        }
        else{
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/taskboard/create.blade.php ENDPATH**/ ?>