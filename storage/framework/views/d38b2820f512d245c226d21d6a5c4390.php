...
<script>
    $('#save').click(function() {
        var url = "<?php echo e(route('vendor-wnine.update', $expiry_date->id)); ?>";
        $.easyAjax({
            url: url,
            container: '#exp_date',
            type: "POST",
...
</script><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendors/wnine/edit.blade.php ENDPATH**/ ?>