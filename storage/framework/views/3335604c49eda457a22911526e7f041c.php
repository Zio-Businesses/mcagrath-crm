...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'update-client-file-data-form']); ?>
...
<script>
     ...
     $('body').on('click', '#submit-document', function() {
        var url = "<?php echo e(route('client-docs.update', $file->id)); ?>";
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\clients\files\edit.blade.php ENDPATH**/ ?>