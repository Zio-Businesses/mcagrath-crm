...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('events.show', $notification->data['id']),'image' => user()->image_url,'title' => __('email.newEvent.statusSubject'),'text' => $notification->data['event_name'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/event_status_note.blade.php ENDPATH**/ ?>