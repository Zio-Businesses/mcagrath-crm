...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.productCategory.category'); ?></h5>
...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($category->id); ?>">
                ...
                <td class="text-right">
                    <?php if($deleteProductCategoryPermission == 'all' || ($deleteProductCategoryPermission == 'added' && $category->id == user()->id)): ?>
...
<script>
    $('.delete-category').click(function() {
        ...
        let url = "<?php echo e(route('productCategory.destroy', ':id')); ?>";
    ...
    $('#save-category').click(function() {
        const url = "<?php echo e(route('productCategory.store')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('[contenteditable=true]').focus(function() {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            let url = "<?php echo e(route('productCategory.update', ':id')); ?>";
            url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/products/category/create.blade.php ENDPATH**/ ?>