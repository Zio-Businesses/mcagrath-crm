...
<div class="container-fluid">
    ...
    <p>
        ...
        <form class="form-fix-translation" method="POST" action="<?php echo e(route('language_settings.fix_translation')); ?>" data-remote="true" role="form" data-confirm="<?php echo app('translator')->get('modules.languageSettings.fixTranslationInfo'); ?>">
            <div class="form-group">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <button type="submit" class="btn btn-info" data-disable-with="<?php echo app('translator')->get('app.processing'); ?>..." ><?php echo app('translator')->get('modules.languageSettings.fixTranslation'); ?></button>
            </div>
        </form>
        <?php endif; ?>
        <?php if(isset($group)) : ?>
    ...
    <?php else: ?>
        <fieldset>
            ...
            <?php if(!\Illuminate\Support\Facades\File::exists(base_path() . '/resources/lang/en')): ?>
                <form class="form-create-en-locale" method="POST"
                action="<?php echo e(route('language_settings.create_en_locale')); ?>" data-remote="true" role="form"
                data-confirm="Are you sure you want to create en locale?">
                    <div class="form-group">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="btn btn-info" data-disable-with="<?php echo app('translator')->get('app.processing'); ?>..." >Create en locale</button>
                    </div>
                </form>
            <?php endif; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendor/translation-manager/index.blade.php ENDPATH**/ ?>