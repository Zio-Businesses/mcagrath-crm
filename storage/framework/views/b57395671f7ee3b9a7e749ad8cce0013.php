...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.proposal.name'),'fieldName' => 'name','fieldId' => 'name','fieldPlaceholder' => __('placeholders.name'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                            ...
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="<?php echo e($invoiceSetting->hsn_sac_code_show ? '40%' : '50%'); ?>" style="padding: 5px;">
                                            <table width="100%">
                                                <tbody>
                                                    <tr>
...
<script>
    $(document).ready(function() {
        ...
        function addProduct(id) {
            ...
            $.easyAjax({
                url: "<?php echo e(route('proposal-template.add_item')); ?>",
                type: "GET",
                data: {
                    id: id,
        ...
        $(document).on('click', '#add-item', function() {
            ...
            item +=
                `<td width="10%" class="border-0" align="right" id="type"><?php echo app('translator')->get("modules.invoices.qty"); ?></td>
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "<?php echo e(route('proposal-template.store')); ?>",
                container: '#saveInvoiceForm',
                type: "POST",
                blockUI: true,
                redirect: true,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/proposal-template/ajax/create.blade.php ENDPATH**/ ?>