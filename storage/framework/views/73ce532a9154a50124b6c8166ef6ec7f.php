...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'updateAppreciationType']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('modules.appreciations.editAppreciationType'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'title','fieldLabel' => __('app.title'),'fieldName' => 'title','fieldRequired' => 'true','fieldValue' => $appreciationType->title,'fieldPlaceholder' => __('app.title')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'icon','fieldLabel' => __('modules.appreciations.chooseIcon'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                    ...
                                    data-live-search="true">
                                        ...
                                        <option data-icon="<?php echo e($item->icon); ?>"  <?php echo e(($appreciationType->award_icon_id == $item->id) ? 'selected' : ''); ?> data-content="<i class='bi bi-<?php echo e($item->icon); ?>'></i> <?php echo e($item->title); ?>" value="<?php echo e($item->id); ?>">
...
<?php endif; ?>
                            ...
                            <div class="col-md-4 col-lg-4">
                                <div class="form-group my-3">
                                    <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'colorselector','fieldRequired' => 'true','fieldLabel' => __('modules.awards.backgroundColor')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes(['id' => 'colorpicker']); ?>
                                        <input type="text" class="form-control height-35 f-14"
                                            placeholder="<?php echo e(__('placeholders.colorPicker')); ?>" name="color_code" id="colorselector" value="<?php echo e($appreciationType->color_code); ?>">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <option <?php if($appreciationType->status == 'active'): echo 'selected'; endif; ?> value="active"><?php echo app('translator')->get('app.active'); ?></option>
                                    <option <?php if($appreciationType->status == 'inactive'): echo 'selected'; endif; ?>  value="inactive"><?php echo app('translator')->get('app.inactive'); ?></option>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('modules.contracts.summery'),'fieldName' => 'summery','fieldId' => 'summery','fieldValue' => $appreciationType->summary ?? ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-appreciation-type','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        $('#colorpicker').colorpicker({
            "color": "<?php echo e($appreciationType->color_code); ?>"
        });
        ...
        $('#save-appreciation-type').click(function() {
            const url = "<?php echo e(route('awards.update', $appreciationType->id)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/awards/ajax/edit.blade.php ENDPATH**/ ?>