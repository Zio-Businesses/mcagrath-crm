...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('invoices.show', $notification->data['id']),'image' => company()->logo_url,'title' => __('email.invoice.updateSubject'),'text' => $notification->data['invoice_number'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/client/invoice_updated.blade.php ENDPATH**/ ?>