...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createProjectCategory','class' => 'ajax-form']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-project-category']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-project-category').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('project-settings.saveProjectCategory')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/project-settings/create-project-category-settings-modal.blade.php ENDPATH**/ ?>