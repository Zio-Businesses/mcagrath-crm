...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('recurring-invoices.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 float-left']); ?>
                        <?php echo app('translator')->get('app.addInvoiceRecurring'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $('body').on('click', '.delete-invoice', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('recurring-invoices.destroy', ':id')); ?>";
        ...
        $('body').on('change', '.change-invoice-status', function () {
            ...
            var url = "<?php echo e(route('recurring_invoice.change_status')); ?>";
            var token = "<?php echo e(csrf_token()); ?>";
            var id =  $(this).data('invoice-id');
            var status = $(this).val();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/recurring-invoices/index.blade.php ENDPATH**/ ?>