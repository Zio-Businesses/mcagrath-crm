<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.menu.editConsent'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'updateConsent','class' => 'form-horizontal']); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.name'),'fieldPlaceholder' => __('placeholders.consent'),'fieldName' => 'name','fieldId' => 'name','fieldValue' => $consent->name,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('app.description'),'fieldName' => 'description','fieldId' => 'description','fieldPlaceholder' => __('placeholders.consentDescription'),'fieldValue' => $consent->description,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-consent']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-consent').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('gdpr.update_consent', $consent->id)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/gdpr-settings/edit-consent-modal.blade.php ENDPATH**/ ?>