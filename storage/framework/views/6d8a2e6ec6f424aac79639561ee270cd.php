...
<?php $component->withAttributes(['class' => 'border-0 pb-3 admin-dash-table table-hover']); ?>
                     ...
                     <?php $__env->slot('thead', null, []); ?> 
                        ...
                        <?php if(in_array($manageProjectTemplatePermission, ['all', 'added'])): ?>
                        <th class="text-right pr-20"><?php echo app('translator')->get('app.action'); ?></th>
                        <?php endif; ?>
                     <?php $__env->endSlot(); ?>

                    <?php $__empty_1 = true; $__currentLoopData = $template->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<script>
    $('#add-project-member').click(function() {
        const url = "<?php echo e(route('project-template-member.create')); ?>" + "?id=<?php echo e($template->id); ?>";
    ...
    $('.delete-row').click(function() {
        ...
        var url = "<?php echo e(route('project-template-member.destroy', ':id')); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/project-templates/ajax/members.blade.php ENDPATH**/ ?>