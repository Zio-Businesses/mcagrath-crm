...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-method','data-sitekey' => ''.e($key).'','data-callback' => 'saveForm','data-error-callback' => 'errorMsg','class' => 'g-recaptcha']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/security-settings/verify-recaptcha-v3.blade.php ENDPATH**/ ?>