...
<script>
    $('#save').click(function() {
        var url = "<?php echo e(route('vendor-buisness-license.update', $expiry_date->id)); ?>";
        $.easyAjax({
            url: url,
            container: '#exp_date',
            type: "POST",
...
</script><?php /**PATH C:\xampp\htdocs\public_html\resources\views/vendors/buisness-license/edit.blade.php ENDPATH**/ ?>