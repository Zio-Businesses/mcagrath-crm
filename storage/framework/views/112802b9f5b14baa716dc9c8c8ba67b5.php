...
<div class="bg-white rounded b-shadow-4 create-inv">
    ...
    <div class="px-lg-4 px-md-4 px-3 py-3">
        <h4 class="mb-0 f-21 font-weight-normal text-capitalize"><?php echo app('translator')->get('app.estimateTemplateDetails'); ?>
        </h4>
    </div>
    <!-- HEADING END -->
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.name'),'fieldName' => 'name','fieldId' => 'name','fieldPlaceholder' => '','fieldRequired' => 'true','fieldValue' => $estimate->name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                    ...
                    <div class="select-others height-35 rounded">
                        <select class="form-control select-picker" name="currency_id" id="currency_id">
                            <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($currency->id == $estimate->currency_id): ?> selected <?php endif; ?> value="<?php echo e($currency->id); ?>">
                                ...
                                <tbody>
                                    ...
                                    <tr class="d-none d-md-block d-lg-table-row">
                                        ...
                                        <td class="border-left-0">
                                            ...
                                            <?php if($item->EstimateTemplateItemImage && $item->EstimateTemplateItemImage->external_link): ?>
                                                data-show-remove="false"
                                            <?php endif; ?>
                                            />
                                            <input type="hidden" name="invoice_item_image_url[]" value="<?php echo e($item->EstimateTemplateItemImage ? $item->EstimateTemplateItemImage->file : ''); ?>">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
<?php $component = App\View\Components\Forms\ButtonCancel::resolve(['link' => route('estimate-template.index')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        file.on('dropify.beforeClear', function(event, element) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "<?php echo e(route('estimate-template.delete_image')); ?>";
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "<?php echo e(route('estimate-template.update', $estimate->id)); ?>",
                container: '#saveInvoiceForm',
                type: "POST",
                blockUI: true,
                redirect: true,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/estimates-templates/ajax/edit.blade.php ENDPATH**/ ?>