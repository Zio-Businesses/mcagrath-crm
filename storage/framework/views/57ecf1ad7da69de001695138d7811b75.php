<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.addLanguage'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createLanguage','class' => 'form-horizontal']); ?>
            <div class="row">

                <div class="col-lg-6">
                    <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.name'),'fieldPlaceholder' => __('placeholders.language.languageName'),'fieldName' => 'language_name','fieldId' => 'language_name','fieldValue' => '','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="col-lg-6">
                    <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.language_code'),'fieldPlaceholder' => __('placeholders.language.languageCode'),'fieldName' => 'language_code','fieldId' => 'language_code','fieldValue' => '','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                        ...
                        <?php $__currentLoopData = $flags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            value="<?php echo e($flag->code); ?>"><?php echo e($flag->name); ?></option>
...
<script>
    ...
    $('#save-language').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('language-settings.store')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/language-settings/create-language-settings-modal.blade.php ENDPATH**/ ?>