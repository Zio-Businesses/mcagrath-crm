...
<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.addVisa'); ?></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.employees.visaNumber'),'fieldName' => 'visa_number','fieldId' => 'visa_number','fieldValue' => '','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('#save-visa-form').click(function(){
        $.easyAjax({
                    url: "<?php echo e(route('employee-visa.store')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/employees/ajax/create-visa-modal.blade.php ENDPATH**/ ?>