...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
         ...
         <?php $__env->endSlot(); ?>
        <pre>Delete Permission: <?php echo e($deleteStatusPermission); ?></pre>
        ...
        <tr id="row-<?php echo e($item->id); ?>">
            ...
            <td class="text-right">
                <div>
                    Permission Value: <?php echo e($deleteStatusPermission); ?>

                </div>
              
                <?php if($deleteStatusPermission == 'all'): ?>
...
</script><?php /**PATH C:\xampp\htdocs\Mcagrath\mcagrath-crm\resources\views/lead-contact/notes/status.blade.php ENDPATH**/ ?>