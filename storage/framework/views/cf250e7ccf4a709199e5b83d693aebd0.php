...
<div class="row">
    <?php if(in_array('projects', user_modules()) && in_array('total_project', $activeWidgets)): ?>
...
<?php endif; ?>
    ...
    <?php if(in_array('projects', user_modules()) && in_array('total_overdue_project', $activeWidgets)): ?>
        <div class="col-xl-3 col-lg-6 col-md-6 mb-3">
...
<div class="row">
    <?php if(in_array('projects', user_modules()) && in_array('status_wise_project', $activeWidgets)): ?>
...
<?php endif; ?>
    ...
    <?php if(in_array('projects', user_modules()) && in_array('pending_milestone', $activeWidgets)): ?>
        <div class="col-sm-12 col-lg-6 mt-3">
            <?php if (isset($component)) { $__componentOriginalbc9540fa671f26a0f8028a5a8d8f93e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbc9540fa671f26a0f8028a5a8d8f93e9 = $attributes; } ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/dashboard/ajax/project.blade.php ENDPATH**/ ?>