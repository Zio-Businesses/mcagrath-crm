<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.client.clientSubCategory'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'table-bordered client-subcat-table']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($subcategory->id); ?>">
                ...
                <td data-row-id="<?php echo e($subcategory->id); ?>" contenteditable="true">
                    <?php echo e($subcategory->category_name); ?></td>
                <td><?php echo e($subcategory->clientCategory->category_name); ?></td>

                <td class="text-right">
                    <?php if($deletePermission == 'all' || $deletePermission == 'added'): ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'create_category_id','fieldLabel' => __('modules.client.clientCategory'),'fieldName' => 'category_id','search' => 'true','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('.delete-category').click(function() {
        ...
        var url = "<?php echo e(route('clientSubCategory.destroy', ':id')); ?>";
    ...
    $('#save-category').click(function() {
        var url = "<?php echo e(route('clientSubCategory.store')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('.client-subcat-table [contenteditable=true]').focus(function() {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            var url = "<?php echo e(route('clientSubCategory.update', ':id')); ?>";
            url = url.replace(':id', id);
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\clients\create-subcategory.blade.php ENDPATH**/ ?>