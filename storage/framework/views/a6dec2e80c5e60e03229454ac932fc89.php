...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.projects.projectName'),'fieldName' => 'project_name','fieldRequired' => 'true','fieldId' => 'project_name','fieldValue' => $template->project_name,'fieldPlaceholder' => __('placeholders.project')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                <select class="form-control select-picker" name="category_id" id="project_category_id"
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($template->category_id == $category->id): ?> selected <?php endif; ?> value="<?php echo e($category->id); ?>">
...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldId' => 'manual_timelog','fieldLabel' => __('modules.projects.manualTimelog'),'checked' => ($template->manual_timelog
                                    == 'enable') ? 'true' : 'false','fieldName' => 'manual_timelog'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                    ...
                    <div class="col-md-4 col-lg-4 d-none" id="clientNotification">
                        <div class="form-group">
                            <div class="d-flex mt-3">
                                <?php if (isset($component)) { $__componentOriginal9c5d7e5b2e4b8b16cfa941b5e69189f3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9c5d7e5b2e4b8b16cfa941b5e69189f3 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldId' => 'client_task_notification','checked' => ($template->allow_client_notification
                                == 'enable') ? 'true' : 'false','fieldLabel' => __('modules.projects.clientTaskNotification'),'fieldName' => 'client_task_notification'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Checkbox::class))->getConstructor()): ?>
...
<?php unset($__componentOriginal89b295b0763c93abe0143426334eb5d6); ?>
<?php endif; ?>
                            <div id="project_summary"><?php echo $template->project_summary; ?></div>
                            <textarea name="project_summary" id="project_summary-text"
                                class="d-none"><?php echo $template->project_summary; ?></textarea>
                        </div>
                    </div>
...
<?php unset($__componentOriginal89b295b0763c93abe0143426334eb5d6); ?>
<?php endif; ?>
                            <div id="notes"><?php echo $template->notes; ?></div>
                            <textarea name="notes" id="notes-text" class="d-none"><?php echo $template->notes; ?></textarea>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-project-form').click(function() {
            ...
            const url = "<?php echo e(route('project-template.update', $template->id)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/project-templates/ajax/edit.blade.php ENDPATH**/ ?>