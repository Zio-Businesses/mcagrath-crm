                ...
                <div class="select-box py-2 px-lg-2 px-md-2 px-0 ml-2">
                    <div class="select-status">
                        <select class="mt-3 form-control select-picker" id="client_id" name="client_id" data-live-search="true">
                            <option value="all"><?php echo app('translator')->get('modules.payments.filterByCustomer'); ?></option>
            ...
            <div class="select-box py-2 px-lg-2 px-md-2 px-0 ml-2">
                <div class="select-status">
                    <select class="mt-3 form-control select-picker" id="payment_gateway" name="payment_gateway" data-live-search="true">
                        <option value="all"><?php echo app('translator')->get('modules.payments.selectPaymentMethod'); ?></option>
                        ...
                        <?php if($paymentGateway->authorize_status == 'active'): ?>
                            <option value="authorize"><?php echo e(__('app.authorize')); ?>
                        ...
                        <?php if($paymentGateway->flutterwave_status == 'active'): ?>
                            <option value="flutterwave"><?php echo e(__('app.flutterwave')); ?>
            ...
            <div class="select-box py-2 px-lg-2 px-md-2 px-0 ml-2 d-none" id="offline_gateway">
                <div class="select-status">
                    <select class="mt-3 form-control select-picker" id="offline_gateway_data" name="offline_gateway_data" data-live-search="true">
                        <option value="all"><?php echo app('translator')->get('modules.payments.selectOfflineMethod'); ?></option>
                        <?php $__currentLoopData = $offlineMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offlineMethod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($offlineMethod->id); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-bulk-payment-form']); ?>
                    ...
                    <div class="col-md-12 table-responsive">
                        <table width="100%" class="table" id="bulk-data-table">
                            <thead lass="thead-light">
                                <tr>
                                    <td class="border-bottom-0 btrr-mbl btlr text-dark text-left pl-0"><?php echo app('translator')->get('modules.invoices.invoiceNumber'); ?> #</td>
                                    ...
                                    <td class="text-right pr-0"><?php echo app('translator')->get('modules.invoices.invoiceBalanceDue'); ?></td>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        <td class="border-bottom-0 btrr-mbl btlr text-left pl-0">
                                            <input type="hidden" id="invoice_number" name="invoice_number[]"
                                                value="<?php echo e($pendingPayment->id); ?>">
                                            <?php echo e($pendingPayment->invoice_number); ?>

                                        </td>
                                        <td class="border-bottom-0 btrr-mbl btlr">
                                            <div class="input-group">
                                                <input type="text" data-id="<?php echo e($key); ?>"
                                                    id="payment_date<?php echo e($key); ?>" name="payment_date[]"
                                        ...
                                        <td class="border-bottom-0 btrr-mbl btlr">
                                            <div class="input-group" id="add_offline<?php echo e($key); ?>">
                                                <select class="form-control select-picker add_offline_methods"
                                                    id="add_offline_methods<?php echo e($key); ?>" data-id="<?php echo e($key); ?>"
                                            ...
                                            <input type="hidden" id="offline_method_id<?php echo e($key); ?>"
                                                        ...
                                                        <?php if($viewBankAccountPermission != 'none'): ?>
                                                            <?php $__currentLoopData = $bankDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($pendingPayment->currency->id == $bankDetail->currency_id): ?>
                                                                    <option <?php if($pendingPayment->bank_account_id == $bankDetail->id): echo 'selected'; endif; ?> value="<?php echo e($bankDetail->id); ?>"><?php if($bankDetail->type == 'bank'): ?>
                                        ...
                                        <td class="border-bottom-0 btrr-mbl btlr">
                                            <div class="input-group">
                                                <input type="number" class="form-control height-35 f-14 amount"
                                                    name="amount[]" id="amount<?php echo e($key); ?>"
...
<script>
    $(document).ready(function() {
        ...
        const showTable = () => {
            ...
            var url = "<?php echo e(route('payments.add_bulk_payments')); ?>?client_id=" + clientID + '&payment_id=' + paymentID + '&offline_id=' + offlineID;
            $.easyAjax({
                url: url,
                type: "GET",
                disableButton: true,
        ...
        $(document).on('click', '#save-bulk-payment-button', function() {
            const url = "<?php echo e(route('payments.save_bulk_payments')); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/payments/ajax/add-bulk-payments.blade.php ENDPATH**/ ?>