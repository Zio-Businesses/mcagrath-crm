                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 method"
                                href="<?php echo e(route('lead-settings.index')); ?>?tab=notestitle" role="tab"
                                aria-controls="nav-leadAgent" aria-selected="true"><?php echo app('translator')->get('Notes Title'); ?>
                            </a>
                        </div>
                    </nav>
                </div>
...
<?php endif; ?>
                        <?php endif; ?>
                        <?php if($addPipelinePermission != 'none' && $addPipelinePermission != false): ?>
                            <?php if (isset($component)) { $__componentOriginalcf8d12533ff890e0d6573daf32b7618d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d = $attributes; } ?>
<?php $component = App\View\Components\Forms\ButtonPrimary::resolve(['icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.button-primary'); ?>
...
<?php endif; ?>
                        <?php endif; ?>
                        <?php if($mangeLeadStagePermission != false && $mangeLeadStagePermission != 'none'): ?>
                            <?php if (isset($component)) { $__componentOriginalcf8d12533ff890e0d6573daf32b7618d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d = $attributes; } ?>
<?php $component = App\View\Components\Forms\ButtonPrimary::resolve(['icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.button-primary'); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addNotesTitle','class' => 'notestitle-btn mb-2 d-none actionBtn']); ?>
                                <?php echo app('translator')->get('Add New Notes Title'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
    ...
    <script>
       ...
       $("body").on("click", "#editSettings .nav a", function(event) {
        ...
        $('body').on('click', '#addNotesTitle', function() {
            var url = "<?php echo e(route('notesTitle.create')); ?>";
            $(MODAL_LG + ' ' + MODAL_HEADING).html('...');
            $.ajaxModal(MODAL_LG, url);
        });
        ...
        $('body').on('click', '.edit-notestitle', function() {
            ...
            var url = "<?php echo e(route('notesTitle.edit', ':id ')); ?>";
        ...
        $('body').on('click', '.delete-notestitle', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "<?php echo e(route('notesTitle.destroy', ':id')); ?>";
                    url = url.replace(':id', id);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/lead-settings/index.blade.php ENDPATH**/ ?>