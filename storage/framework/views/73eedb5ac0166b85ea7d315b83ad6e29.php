    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group my-3">
                <label class="f-14 text-dark-grey mb-12 w-100" for="usr"><?php echo app('translator')->get('modules.gdpr.allowLeadToUpdateDataFromPublicForm'); ?></label>
                <div class="d-flex">
...
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'yes1','fieldLabel' => __('app.yes'),'fieldName' => 'public_lead_edit','fieldValue' => '1','checked' => $gdprSetting->public_lead_edit == 1] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginalc709ddc147ddde534205d9546b4fb0db = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc709ddc147ddde534205d9546b4fb0db = $attributes; } ?>
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'no1','fieldLabel' => __('app.no'),'fieldValue' => '0','fieldName' => 'public_lead_edit','checked' => $gdprSetting->public_lead_edit == 0] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.radio'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Radio::class))->getConstructor()): ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/gdpr-settings/ajax/right-to-access.blade.php ENDPATH**/ ?>