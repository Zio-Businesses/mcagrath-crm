<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">
        <?php echo app('translator')->get('modules.flutterwave.details'); ?>
    </h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'flutterwaveDetails','class' => 'ajax-form','action' => ''.e(route('flutterwave_public', [$id])).'']); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.flutterwave.client_name'),'fieldName' => 'name','fieldId' => 'name','fieldPlaceholder' => __('modules.flutterwave.client_name'),'fieldValue' => '','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Email::resolve(['fieldLabel' => __('modules.flutterwave.client_email'),'fieldName' => 'email','fieldId' => 'email','fieldPlaceholder' => __('modules.flutterwave.client_email'),'fieldValue' => '','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Tel::resolve(['fieldLabel' => __('modules.flutterwave.client_phone'),'fieldName' => 'phone','fieldId' => 'phone','fieldPlaceholder' => __('modules.flutterwave.client_phone'),'fieldValue' => ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-flutterwave-detail']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-flutterwave-detail').click( function () {
        ...
        var url = "<?php echo e(route('flutterwave_public', $id)); ?>";
        $.easyAjax({
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/public-payment/flutterwave/index.blade.php ENDPATH**/ ?>