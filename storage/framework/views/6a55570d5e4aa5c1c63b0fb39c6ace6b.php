...
<?php $component = App\View\Components\Forms\Password::resolve(['fieldId' => 'password','fieldLabel' => __('app.password'),'fieldName' => 'password','fieldPlaceholder' => __('placeholders.renterPassword'),'fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'check-password']); ?><?php echo app('translator')->get('app.verify'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/projects/notes/verify-password.blade.php ENDPATH**/ ?>