...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('projects.show', $notification->data['project']['id']),'image' => user()->image_url,'title' => __('modules.tasks.timerStartedProject'),'text' => $notification->data['project']['project_name'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/client/timer_started.blade.php ENDPATH**/ ?>