...
<?php $component->withAttributes(['id' => 'createStatus','class' => 'ajax-form']); ?>
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.addNew'); ?> <?php echo app('translator')->get('modules.deal.leadStage'); ?></h5>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'stagePipeline','fieldLabel' => __('modules.deal.pipeline'),'fieldName' => 'pipeline[]','fieldRequired' => 'true','multiple' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'name','fieldLabel' => __('modules.deal.leadStage'),'fieldName' => 'name','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.status')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('#save-status').click(function() {
        $.easyAjax({
            url: "<?php echo e(route('lead-stage-setting.store')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/lead-settings/create-stage-modal.blade.php ENDPATH**/ ?>