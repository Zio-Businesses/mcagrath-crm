...
<script>
    ...
    var orderComplete = function (paymentIntentId) {
        ...
        cardButton.disabled = true;
        $.easyAjax({
            url: "<?php echo e(route('stripe_public', $invoice->hash)); ?>",
            ...
            type: "POST",
            redirect: true,
            data: {paymentIntentId: paymentIntentId, "_token": "<?php echo e(csrf_token()); ?>"},
        })
    };

    var paymentFailed = function (result) {
        $.easyAjax({
            url: "<?php echo e(route('front.invoice_payment_failed', [$invoice->id])); ?>",
            container: '#invoice_container',
            type: "POST",
            redirect: true,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/public-payment/stripe/stripe-payment.blade.php ENDPATH**/ ?>