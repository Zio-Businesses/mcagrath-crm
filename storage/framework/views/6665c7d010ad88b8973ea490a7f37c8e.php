...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('vendor-estimates.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $('#vendor-estimates-table').on('change', '.change-cbid', function() {
            ...
            var value =  $(this).val();
            var url="<?php echo e(route('vendors.changecbid',':id')); ?>";
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('vendor-estimates.destroy', ':id')); ?>";
                    url = url.replace(':id', id);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/estimates-vendor/index.blade.php ENDPATH**/ ?>