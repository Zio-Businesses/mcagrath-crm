...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('dashboard'),'image' => $notificationUser->image_url,'title' => __('email.shiftScheduled.subject') . ' - '.Carbon::parse($notification->data['date'])->translatedFormat(company()->date_format),'text' => __('modules.attendance.shiftName').': '.$shift->shift_name,'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/shift_scheduled.blade.php ENDPATH**/ ?>