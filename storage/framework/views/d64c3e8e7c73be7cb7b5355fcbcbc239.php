...
<head>
    ...
    <title><?php echo app('translator')->get('modules.contracts.contractNumber'); ?> - #<?php echo e($contract->id); ?></title>
                        ...
                        <tr>
                            <td class="f-14 text-black">
                                ...
                                <p class="line-height mb-0">
                                    <span class="text-grey text-capitalize"><?php echo app('translator')->get('app.menu.vendor'); ?></span><br>
                                    
                                    <?php echo e($contract->vendor_name); ?><br/>
                                    <?php echo nl2br($contract->street_address); ?><br/>
                                    <?php echo e($contract->city); ?>, <?php echo e($contract->state); ?>, <?php echo e($contract->zip_code); ?><br/>
                                </p>

                            </td>

                            <td align="right">
                                <?php if($contract->company_logo): ?>
                                    <div class="text-uppercase bg-white unpaid rightaligned">
                                        <img src="<?php echo e($contract->image_url); ?>"
                                            alt="<?php echo e($contract->company_name); ?>"
                                            class="logo" />
                                    </div>
                                <?php endif; ?>
                            </td>
...
<br/>
 <strong>MCGRATH CONSULTING</strong> operates as a private network. We will hire you and compensate you for the work order. You are required to communicate exclusively with us regarding this work order and must not engage with our tenant or provide any information to the tenant or our client. Breach of this agreement will result in direct termination of this contract and your vendor profile there by restricting you from receiving future work orders.
        ...
        <hr class="mt-1 mb-1">
        <?php if($contract->contract_sign): ?>
            <div style="text-align: left; margin-top: 10px">
                <h4 class="name" style="margin-bottom: 20px;"><?php echo app('translator')->get('Vendor Signature'); ?></h4>
                <img src="<?php echo e($contract->secondary_image_url); ?>" style="width: 200px;">
                <p>Vendor Name:- <?php echo e($contract->vendor_name); ?><br>
                   Company Name:- <?php echo e($contract->company_name); ?><br>
                   Date:- <?php echo e($contract->signed_date); ?>
        ...
        <?php if($contract->company_sign): ?>
            <div style="text-align: right; margin-top: -240px">
                ...
                <img src="<?php echo e($contract->tertiary_image_url); ?>" style="width: 200px;"><br>
                <p>Company Name:- <?php echo e($company->company_name); ?><br>
                    Date:- <?php echo e($contract->company_sign_date); ?><br>
                </p>
            </div>
        <?php endif; ?>
    </div>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendors/contract-pdf.blade.php ENDPATH**/ ?>