<?php if(count($updateArray) > 0 && in_array('admin', user_roles())): ?>
...
<?php $component->withAttributes(['type' => 'danger']); ?>
                <div class="d-flex justify-content-between">
                    <div class="align-self-center">
                        <b>Note:-</b> Please update and reactivate  <b><?php echo e(implode(', ', $updateArray)); ?></b>
                        <?php if(count($updateArray)>1): ?> modules <?php else: ?> module <?php endif; ?>
                        to make the
...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('custom-modules.index').'?tab=custom'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Update Custom Modules <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\dashboard\update-message.blade.php ENDPATH**/ ?>