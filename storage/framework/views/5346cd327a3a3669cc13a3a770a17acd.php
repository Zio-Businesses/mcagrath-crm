...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('messages.index') . '?user=' . $notification->data['user_one'],'image' => $notificationUser->image_url,'title' => __('email.newChat.mentionSubject'),'text' => $notificationUser->name,'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/new_mention_chat.blade.php ENDPATH**/ ?>