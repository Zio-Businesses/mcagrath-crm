...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'title','fieldLabel' => __('app.title'),'fieldName' => 'title','fieldPlaceholder' => __('placeholders.title'),'fieldValue' => $contact->title] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Email::resolve(['fieldId' => 'email','fieldLabel' => __('app.email'),'fieldName' => 'email','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.email'),'fieldValue' => $contact->email] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-4">
                        <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'phone','fieldLabel' => __('app.phone'),'fieldName' => 'phone','fieldPlaceholder' => __('placeholders.mobile'),'fieldValue' => $contact->phone] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-client-form').click(function() {
            const url = "<?php echo e(route('client-contacts.update', $contact->id)); ?>";
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\clients\contacts\edit.blade.php ENDPATH**/ ?>