...
<?php $component->withAttributes(['id' => 'save-bankaccount-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('modules.bankaccount.updateBankAccount'); ?></h4>
                    <div class="row p-20">
...
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'type-bank','fieldLabel' => __('modules.bankaccount.bank'),'fieldValue' => 'bank','fieldName' => 'type','checked' => $bankAccount->type == 'bank'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                    <?php if (isset($component)) { $__componentOriginalc709ddc147ddde534205d9546b4fb0db = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc709ddc147ddde534205d9546b4fb0db = $attributes; } ?>
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'type-cash','fieldLabel' => __('modules.bankaccount.cash'),'fieldValue' => 'cash','fieldName' => 'type','checked' => $bankAccount->type == 'cash'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.radio'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Radio::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <div class="col-md-4 bank_name <?php if($bankAccount->type == 'cash'): ?> d-none <?php endif; ?>">
                            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'bank_name','fieldLabel' => __('modules.bankaccount.bankName'),'fieldName' => 'bank_name','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.bankaccount.bankName'),'fieldValue' => $bankAccount->bank_name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div class="col-md-4 accountNumber <?php if($bankAccount->type == 'cash'): ?> d-none <?php endif; ?>">
                            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'account_number','fieldLabel' => __('modules.bankaccount.accountNumber'),'fieldName' => 'account_number','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.bankaccount.accountNumber'),'fieldValue' => $bankAccount->account_number] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <div class="col-md-4 accountType <?php if($bankAccount->type == 'cash'): ?> d-none <?php endif; ?>">
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <option value="saving" <?php if($bankAccount->account_type == 'saving'): ?> selected <?php endif; ?>><?php echo app('translator')->get('modules.bankaccount.saving'); ?></option>
                                <option value="current" <?php if($bankAccount->account_type == 'current'): ?> selected <?php endif; ?>><?php echo app('translator')->get('modules.bankaccount.current'); ?></option>
                                <option value="credit card" <?php if($bankAccount->account_type == 'credit card'): ?> selected <?php endif; ?>><?php echo app('translator')->get('modules.bankaccount.creditCard'); ?></option>
                                <option value="loan" <?php if($bankAccount->account_type == 'loan'): ?> selected <?php endif; ?>><?php echo app('translator')->get('modules.bankaccount.loan'); ?></option>
                                <option value="overdraft" <?php if($bankAccount->account_type == 'overdraft'): ?> selected <?php endif; ?>><?php echo app('translator')->get('modules.bankaccount.overdraft'); ?></option>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                                    ...
                                    <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($currency->id == $bankAccount->currency_id): ?> selected <?php endif; ?> value="<?php echo e($currency->id); ?>">
...
<?php $component = App\View\Components\Forms\Number::resolve(['fieldId' => 'opening_balance','fieldLabel' => __('modules.bankaccount.openingBalance'),'fieldName' => 'opening_balance','fieldPlaceholder' => __('placeholders.bankaccount.balance'),'fieldValue' => $bankAccount->opening_balance,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div class="col-md-4">
                            <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'status','fieldLabel' => __('app.status'),'fieldName' => 'status','search' => 'true','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Select::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                                <option value="">--</option>
                                <option value="1" <?php if($bankAccount->status == 1): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.active'); ?></option>
                                <option value="0" <?php if($bankAccount->status == 0): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.inactive'); ?></option>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal67cd5dc9866c6185ad92d933c387fa86)): ?>
<?php $attributes = $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86; ?>
...
<?php endif; ?>
                        ...
                        <div class="col-md-12 bankLogo <?php if($bankAccount->type == 'cash'): ?> d-none <?php endif; ?>">
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg bmp','fieldLabel' => __('modules.bankaccount.bankLogo'),'fieldName' => 'bank_logo','fieldId' => 'bank_logo','fieldValue' => ($bankAccount->bank_logo ? $bankAccount->file_url : ''),'popover' => __('modules.themeSettings.logoSize')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-bankaccount').click(function() {
            const url = "<?php echo e(route('bankaccounts.update', [$bankAccount->id])); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/bank-account/ajax/edit.blade.php ENDPATH**/ ?>