...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'import-lead-data-form']); ?>
            <div class="add-lead bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.importLead'); ?></h4>
                <div class="col-sm-12 pt-2">
                    <div class="alert alert-warning" role="alert">
                        <?php echo app('translator')->get('app.importLeadExcelInfo'); ?>
                    </div>
                </div>
                <div class="row py-20">
                    <div class="col-md-12">
...
<?php $component = App\View\Components\Forms\File::resolve(['fieldLabel' => __('modules.import.file'),'fieldName' => 'import_file','fieldId' => 'lead_import'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'import-lead-form','class' => 'mr-3']); ?><?php echo app('translator')->get('app.uploadNext'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '#import-lead-form', function() {
            const url = "<?php echo e(route('lead-contact.import.store')); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/leads/ajax/import.blade.php ENDPATH**/ ?>