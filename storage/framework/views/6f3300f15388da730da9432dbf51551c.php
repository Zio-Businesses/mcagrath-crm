...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.appreciations.addAppreciationType'); ?></h5>
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('modules.contracts.summery'),'fieldName' => 'summery','fieldId' => 'summery'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-appreciationType']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-appreciationType').click(function() {
            var url = "<?php echo e(route('awards.quick-store')); ?>";
            $.easyAjax({
                url: url,
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\appreciations\ajax\create_appreciation_type.blade.php ENDPATH**/ ?>