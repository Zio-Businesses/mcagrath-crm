<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.updateReply'); ?></h5>
...
<?php endif; ?>
                        <div id="description"><?php echo $reply->body; ?></div>
...
<script>
    ...
    $('#save-discussion').click(function () {
        ...
        $.easyAjax({
            url: "<?php echo e(route('discussion-reply.update', $reply->id)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/discussions/replies/edit.blade.php ENDPATH**/ ?>