...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('deals.show', $notification->data['id']).'?tab=follow-up','image' => company()->logo_url,'title' => __('email.followUpReminder.subject') . ' #' . $notification->data['id'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/auto_follow_up_reminder.blade.php ENDPATH**/ ?>