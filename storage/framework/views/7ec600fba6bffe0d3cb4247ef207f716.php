...
<?php $component->withAttributes(['id' => 'createAgent','class' => 'form-horizontal']); ?>
    <div class="modal-header">
        <h5 class="modal-title"><?php echo app('translator')->get('app.addNewDealAgent'); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    </div>
    <div class="modal-body">
        <div class="portlet-body">
                <div class="row">
                    <input type="hidden" name="deal_category_id" value="<?php echo e(request()->categoryId); ?>">
                    <div class="col-lg-6">
                        <div class="my-3">
                            <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'deal_agents_id','fieldLabel' => __('modules.tickets.chooseAgents'),'fieldName' => 'agent_id','search' => 'true','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\UserOption::resolve(['user' => $emp,'pill' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="col-lg-6">
                    <div class="my-3">
                        <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'lead_category','fieldLabel' => __('modules.deal.dealCategory'),'fieldName' => 'category_id[]','search' => 'true','multiple' => 'true','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Select::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $leadCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leadCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($leadCategory->id); ?>"><?php echo e($leadCategory->category_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal67cd5dc9866c6185ad92d933c387fa86)): ?>
...
<script>
    ...
    $('#save-agent').click(function () {
        ...
        $.easyAjax({
            url: "<?php echo e(route('lead-agent-settings.store')); ?>",
    ...
    $('#deal_agents_id').change(function(){
        ...
        function agentCategories(agentId) {
            $.easyAjax({
                url: "<?php echo e(route('lead_agent.categories')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/lead-settings/create-agent-modal.blade.php ENDPATH**/ ?>