    ...
    <div class="card-body">
        <div class="invoice-table-wrapper">
            <table width="100%" class="">
                <tr class="inv-logo-heading">
                    ...
                    <td align="right" class="font-weight-bold f-21 text-dark text-uppercase mt-4 mt-lg-0 mt-md-0">
                        <?php echo app('translator')->get('modules.estimates.estimateTemplate'); ?></td>
                </tr>
                <tr class="inv-num">
            ...
            <div class="d-flex flex-column">
                <h5><?php echo app('translator')->get('app.name'); ?></h5>
                <p class="f-15"><?php echo e($invoice->name); ?></p>
                <br>
                <h5><?php echo app('translator')->get('app.description'); ?></h5>
                <div class="ql-editor p-0 pb-3"><?php echo $invoice->description; ?></div>
                        ...
                        <table class="inv-detail f-14 table-responsive-sm" width="100%">
                            ...
                            <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($item->type == 'item'): ?>
                                    ...
                                    <?php if($item->item_summary || $item->estimateTemplateItemImage): ?>
                                        <tr class="text-dark f-12">
                                            <td colspan="6" class="border-bottom-0">
                                                <?php echo nl2br(strip_tags($item->item_summary)); ?>

                                                <?php if($item->estimateTemplateItemImage): ?>
                                                    <p class="mt-2">
                                                        <a href="javascript:;" class="img-lightbox" data-image-url="<?php echo e($item->estimateTemplateItemImage->file_url); ?>">
                                                            <img src="<?php echo e($item->estimateTemplateItemImage->file_url); ?>" width="80" height="80" class="img-thumbnail">
                                                        </a>
                                                    </p>
                                                <?php endif; ?>
                                            </td>
...
<!-- INVOICE CARD END -->
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/estimates-templates/ajax/show.blade.php ENDPATH**/ ?>