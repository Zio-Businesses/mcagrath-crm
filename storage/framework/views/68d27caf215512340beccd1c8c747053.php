...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'rightToAccess']); ?>
            <?php echo method_field('put'); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey"><?php echo app('translator')->get('app.menu.profileSettings'); ?></h4>

                <div class="p-20">
                    <div class="row">

                        <input type="hidden" id="redirect_url" name="redirect_url" value="<?php echo e(\Request::fullUrl()); ?>">
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg bmp','fieldLabel' => __('modules.profile.profilePicture'),'fieldValue' => $user->image_url,'fieldName' => 'image','fieldId' => 'profile-image','popover' => __('messages.fileFormat.ImageFile')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.profile.yourName'),'fieldPlaceholder' => __('placeholders.name'),'fieldName' => 'name','fieldId' => 'name','fieldValue' => $user->name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        ...
                        <div class="col-lg-6">
                            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.profile.yourEmail'),'fieldPlaceholder' => __('placeholders.email'),'fieldName' => 'email','fieldId' => 'email','fieldValue' => $user->email] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Forms\Password::resolve(['fieldLabel' => __('modules.profile.yourPassword'),'fieldName' => 'password','fieldId' => 'password','fieldHelp' => __('modules.client.passwordUpdateNote'),'fieldPlaceholder' => __('placeholders.password')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'company_name','fieldLabel' => __('app.company_name')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                <div class="input-group" id="client_company_div">
                                    <input type="text" id="company_name" name="company_name"
                                        ...
                                        placeholder="" value="<?php echo e($user->clientDetails->company_name); ?>">
                                </div>
                            </div>
                        </div>
                        <!-- COMPANY NAME END -->
                        ...
                        <div class="col-md-6">
                            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'website','fieldLabel' => __('modules.client.website'),'fieldName' => 'website','fieldPlaceholder' => __('placeholders.website'),'fieldValue' => $user->clientDetails->website] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <div class="col-lg-6">
                            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.gstNumber'),'fieldPlaceholder' => __('placeholders.invoices.gstNumber'),'fieldName' => 'gst_number','fieldId' => 'gst_number','fieldValue' => $user->clientDetails->gst_number] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group my-3">
                                <label class="f-14 text-dark-grey mb-12 w-100" for="usr"><?php echo app('translator')->get('modules.emailSettings.emailNotifications'); ?></label>
                                <div class="d-flex">
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('modules.gdpr.publicPageConsentInformationBlock'),'fieldName' => 'consent_block','fieldId' => 'consent_block','fieldPlaceholder' => __('placeholders.sampleText'),'fieldValue' => $gdprSetting->consent_block] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-right-to-access-data']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(body).on('click', '#save-right-to-access-data', function() {
        ...
        var url = "<?php echo e(route('profile.update', [ser()->id])); ?>";
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\gdpr\ajax\right-to-access.blade.php ENDPATH**/ ?>