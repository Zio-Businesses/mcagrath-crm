...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg bmp','fieldLabel' => __('modules.projects.uploadFile'),'fieldName' => 'file','fieldId' => 'invoice-file','popover' => __('messages.fileFormat.ImageFile')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $('#save-category').click(function() {
        var url = "<?php echo e(route('invoices.store_file')); ?>";
        $.easyAjax({
            url: url,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/invoices/file_upload.blade.php ENDPATH**/ ?>