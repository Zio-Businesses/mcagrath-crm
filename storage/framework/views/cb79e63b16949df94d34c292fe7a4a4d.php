<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('Add Notes'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createNotes','class' => 'ajax-form']); ?>
...
<script>
    ...
    $('#save-notes').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('vendortrack.notesstore')); ?>",
            data: $('#createNotes').serialize(),
            success: function (response) {
                if (response.status === 'success') {
                    window.location.href="<?php echo e(route('vendortrack.index')); ?>";
                }
            }
        })
    });
</script>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendortrack/create-note-modal.blade.php ENDPATH**/ ?>