...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
             <?php $__env->slot('thead', null, []); ?> 
                <th>#</th>
                <th width="35%"><?php echo app('translator')->get('Work Order Status'); ?></th>
                <th class="text-right"><?php echo app('translator')->get('app.action'); ?></th>
             <?php $__env->endSlot(); ?>

            <?php $__empty_1 = true; $__currentLoopData = $wostatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr id="category-<?php echo e($category->id); ?>">
                    <td>
                        <?php echo e($key + 1); ?>

                    </td>
                    <td> <?php echo e($category->wo_status); ?> </td>
                    <td class="text-right">
                        <div class="task_view">
...
<script>
    ...
    $('#addWorkOrderStatus').click(function () {
        var url = "<?php echo e(route('vendor-settings.createWorkOrderStatus')); ?>";
    ...
    $('.editProjectTask').click(function () {
        ...
        var url = "<?php echo e(route('WorkOrderStatus.edit', ':id')); ?>";
    ...
    $('body').on('click', '.delete-project-task', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var url = "<?php echo e(route('WorkOrderStatus.destroy', ':id')); ?>";
                url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendor-settings/ajax/wostatus.blade.php ENDPATH**/ ?>