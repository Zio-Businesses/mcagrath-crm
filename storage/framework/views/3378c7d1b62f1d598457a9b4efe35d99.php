<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.menu.addConsent'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createConsent','class' => 'form-horizontal']); ?>
            <div class="row">

                <div class="col-lg-12">
                    <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.name'),'fieldPlaceholder' => __('placeholders.consent'),'fieldName' => 'name','fieldId' => 'name','fieldValue' => '','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('#save-consent').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('gdpr.store_consent')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/gdpr-settings/create-consent-modal.blade.php ENDPATH**/ ?>