                ...
                <div class="media">
                    ...
                    <div class="media-body bg-white">
                        <div class="form-group">
                            <div id="task-edit-comment"><?php echo $comment->comment; ?></div>
                            <textarea name="comment" class="form-control invisible d-none"
                                id="task-edit-comment-text"><?php echo $comment->comment; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    var edit_task_comments = "<?php echo e(user()->permission('edit_task_comments')); ?>";
    ...
    $(document).ready(function() {
            ...
            const url = "<?php echo e(route('taskComment.update', $comment->id)); ?>";
            ...
            $.easyAjax({
                ...
                data: {
                    ...
                    '_method': 'PUT',
                    taskId: '<?php echo e($comment->task->id); ?>'
                },
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/tasks/comments/edit.blade.php ENDPATH**/ ?>