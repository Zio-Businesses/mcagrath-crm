...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addChangeNotificationForm']); ?>
    <div class="modal-body">
        <div class="row">
            <input type="hidden" name="vendor_id" value="<?php echo e($projectvendor->id); ?>" />
            <div class="col-md-6">
                <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('Vendor'),'fieldName' => 'vendor','fieldId' => 'vendor','fieldRequired' => 'true','fieldValue' => $projectvendor->vendor_name,'fieldPlaceholder' => __('Vendor'),'fieldReadOnly' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-change-notification']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-change-notification').click(function() {
        var url = "<?php echo e(route('change-notification.store')); ?>";
        $.easyAjax({
            url: url,
...
</script><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/projects/vendors/changenotification.blade.php ENDPATH**/ ?>