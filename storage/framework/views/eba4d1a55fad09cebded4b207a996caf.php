            ...
            <form class="w-100 mr-1 mr-lg-0 mr-md-1 ml-md-1 ml-0 ml-lg-0">
                <div class="input-group bg-grey rounded">
                    ...
                    <input type="text" class="form-control f-14 p-1 border-additional-grey" id="search-text-field"
                        placeholder="<?php echo app('translator')->get('modules.department.searchValidation'); ?>">
                </div>
            </form>
        </div>
        <!-- SEARCH BY TASK END -->
    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                <?php if($addDepartmentPermission == 'all' || $addDepartmentPermission == 'added'): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 openRightModal float-left','data-redirect-url' => ''.e(route('department.hierarchy')).'']); ?>
...
<?php endif; ?>
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="<?php echo e(route('departments.index')); ?>" class="btn btn-secondary f-14" data-toggle="tooltip"
                data-original-title="<?php echo app('translator')->get('modules.leaves.tableView'); ?>"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="<?php echo e(route('department.hierarchy')); ?>" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
            ...
            <div class="col-12 chart-section">
                <div class="row">
                    <div class="col-md-6" id="chartTree">
                        <?php echo $__env->make('departments-hierarchy.chart_tree', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-md-6" id="chartOrganization">
                        <?php echo $__env->make('departments-hierarchy.chart_organization', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script>
            ...
            if (parent_id == 'NewNode') {
                var checkExits = setInterval(() => {
                    if ($('#node-ul-NewNode').length) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('department.changeParent')); ?>",
                            type: "POST",
                            data: {
    ...
    function searchText() {
        ...
        const url = "<?php echo e(route('departments.search')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/departments-hierarchy/index.blade.php ENDPATH**/ ?>