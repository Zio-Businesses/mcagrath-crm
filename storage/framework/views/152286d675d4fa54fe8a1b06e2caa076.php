...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-lead-note-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.leadNoteDetails'); ?></h4>

                <input type="hidden" name="lead_id" value="<?php echo e($leadId); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-lead-note-form','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-lead-note-form').click(function() {
            ...
            const url = "<?php echo e(route('lead-notes.update', $note->id)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/lead-contact/notes/edit.blade.php ENDPATH**/ ?>