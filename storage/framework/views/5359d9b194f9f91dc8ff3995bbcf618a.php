                            ...
                            <div class="select-others height-35 rounded">
                                <select class="form-control select-picker" name="currency_id" id="currency_id">
                                    <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($estimate->currency_id == $currency->id): echo 'selected'; endif; ?>
...
<?php endif; ?>
                            <select class="form-control select-picker" name="status" id="status">
                                <option
                                    <?php if($estimate->status == 'accepted'): echo 'selected'; endif; ?> value="accepted"><?php echo app('translator')->get('modules.estimates.accepted'); ?>
                                </option>
                                <option
                                    <?php if($estimate->status == 'waiting'): echo 'selected'; endif; ?> value="waiting"><?php echo app('translator')->get('modules.estimates.waiting'); ?>
                                </option>
                                <option
                                    <?php if($estimate->status == 'declined'): echo 'selected'; endif; ?> value="declined"><?php echo app('translator')->get('modules.estimates.declined'); ?>
                                </option>
                                <?php if($estimate->status == 'draft'): ?>
                                    <option selected value="draft"><?php echo app('translator')->get('modules.invoices.draft'); ?></option>
                                <?php endif; ?>
                            </select>
                        </div>
                    </div>
                                                                ...
                                                                <td width="50%" align="left" class="c-inv-sub-padding">
                                                                    <div
                                                                        ...
                                                                        <select class="form-control select-picker"
                                                                            ...
                                                                            <option <?php if($estimate->discount_type == 'percent'): echo 'selected'; endif; ?>  value="percent">%</option>
                                                                            <option <?php if($estimate->discount_type == 'fixed'): echo 'selected'; endif; ?>  value="fixed">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/expenses/edit.blade.php ENDPATH**/ ?>