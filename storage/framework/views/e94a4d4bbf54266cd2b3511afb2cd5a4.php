<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.note'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'edit-note-data-form']); ?>
        <div class="row">
            <div class="col-md-12 p-20 ">
                <div class="media">
                    <img src="<?php echo e($note->user->image_url); ?>" class="align-self-start mr-3 taskEmployeeImg rounded"
                        alt="<?php echo e($note->user->name); ?>">
                    <div class="media-body bg-white">
                        <div class="form-group">
                            <div id="task-edit-note"><?php echo $note->note; ?></div>
                            <textarea name="note" class="form-control invisible d-none"
                                id="task-edit-note-text"><?php echo $note->note; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-edit-note']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    var edit_task_notes = "<?php echo e(user()->permission('edit_task_notes')); ?>";

    $(document).ready(function() {
        const atValues = <?php echo json_encode($taskuserData, 15, 512) ?>;
        ...
        $('#save-edit-note').click(function() {
            ...
            const url = "<?php echo e(route('task-note.update', $note->id)); ?>";
            ...
            $.easyAjax({
                ...
                data: {
                    ...
                    '_method': 'PUT',
                    taskId: '<?php echo e($note->task->id); ?>'
                },
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/tasks/notes/edit.blade.php ENDPATH**/ ?>