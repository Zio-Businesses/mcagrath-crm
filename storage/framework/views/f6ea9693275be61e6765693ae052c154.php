...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-currency-format-form']); ?>
        <div class="row">
            <div class="col-lg-6">
...
<div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 pt-3 px-4 border-top-grey">
    <p><?php echo app('translator')->get('modules.currencySettings.sample'); ?> - <span id="formatted_currency"><?php echo e($defaultFormattedCurrency); ?></span>
    </p>
</div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-currency-format']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\currency-settings\ajax\currency-format-setting.blade.php ENDPATH**/ ?>