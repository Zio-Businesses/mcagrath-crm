...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('proposal-template.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3']); ?>
                <?php echo app('translator')->get('modules.proposal.addProposalTemplate'); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <script>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('proposal-template.destroy', ':id')); ?>";
        ...
        const applyQuickAction = () => {
            ...
            var url = "<?php echo e(route('proposal_template.apply_quick_action')); ?>?row_ids=" + rowdIds;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/proposal-template/index.blade.php ENDPATH**/ ?>