...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createAppreciationType']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('modules.appreciations.addAppreciationType'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'title','fieldLabel' => __('app.title'),'fieldName' => 'title','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.appreciation.title')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker" name="icon" id="icon"
                                        ...
                                        <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option data-icon="<?php echo e($item->icon); ?>" data-content="<i class='bi bi-<?php echo e($item->icon); ?>'></i> <?php echo e($item->title); ?>" value="<?php echo e($item->id); ?>">
...
<?php $component->withAttributes(['id' => 'colorpicker']); ?>
                                        <input type="text" class="form-control height-35 f-14"
                                            placeholder="<?php echo e(__('placeholders.colorPicker')); ?>" name="color_code" id="colorselector">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-appreciationType','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-appreciationType').click(function() {
            var url = "<?php echo e(route('awards.store')); ?>";
            $.easyAjax({
                url: url,
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\awards\ajax\create.blade.php ENDPATH**/ ?>