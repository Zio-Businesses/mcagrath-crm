<div class="card ticket-message rounded-0 border-0  <?php if(user()->id == $user->id): ?> bg-white-shade <?php endif; ?>" id="message-<?php echo e($message->id); ?>">
    <div class="card-horizontal">
        ...
        <div class="card-body border-0 pl-0">
            <div class="d-flex">
                <a href="<?php echo e(!is_null($user->employeeDetail) ? route('employees.show', $user->id) : route('clients.show', $user->id)); ?>">
                    ...
                    <div class="dropdown ml-auto message-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                            ...
                            <a class="dropdown-item delete-message"
                                data-row-id="<?php echo e($message->id); ?>" data-user-id="<?php echo e($user->id); ?>" href="javascript:;"><?php echo app('translator')->get('app.delete'); ?></a>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <?php if($message->message != ''): ?>
                <div class="card-text text-dark-grey text-justify mb-2">
                    <span class="ql-editor f-13 px-0"><?php echo nl2br($message->message); ?></span>
                </div>
            <?php endif; ?>
                         ...
                         <?php $__env->slot('action', null, []); ?> 
                            <div class="dropdown ml-auto file-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                    ...
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('ticket-files.download', md5($file->id))); ?>"><?php echo app('translator')->get('app.download'); ?></a>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/components/cards/ticket.blade.php ENDPATH**/ ?>