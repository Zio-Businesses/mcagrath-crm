...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('deals.show', $notification->data['id']),'image' => $notificationUser->image_url,'title' => __('email.dealStatus.subject'),'text' => $notification->data['name'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/deal_stage_updated.blade.php ENDPATH**/ ?>