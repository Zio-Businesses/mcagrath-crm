...
<?php $component->withAttributes([]); ?>
                        <select class="form-control select-picker" data-live-search="true" data-size="8"
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(!empty($item->inventory) && count($item->inventory) > 0 && $item->inventory[0]): ?>
                                    <?php if($item->track_inventory == 1 && $item->inventory[0]->net_quantity > 0): ?>
                        ...
                        <table width="100%">
                            <tbody>
                                <tr class="text-dark-grey font-weight-bold f-14">
                                    ...
                                    <td width="13%" class="border-0 d-none" align="right"><?php echo app('translator')->get('modules.invoices.tax'); ?>
                                    </td>
                                    <td width="17%" class="border-0 bblr-mbl" align="right">
                                        <?php echo app('translator')->get('modules.invoices.amount'); ?></td>
                                </tr>
...
<script>
    $(document).ready(function() {
        ...
        invoiceDropzone.on('queuecomplete', function () {
            window.location.href = projectID ? '<?php echo e(route("projects.show", ["project" => ":projectID", "tab" => "invoices"])); ?>'.replace(':projectID', projectID):'<?php echo e(route("invoices.index")); ?>';
        });
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 'error' && response.showValue === true && exceed == 'direct') {
                        ...
                        const url = "<?php echo e(route('invoices.committed_modal')); ?>" + "?products=" + productIDs;
...
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/invoices/ajax/create.blade.php ENDPATH**/ ?>