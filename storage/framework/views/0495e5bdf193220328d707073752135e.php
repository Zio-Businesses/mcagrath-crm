...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
             <?php $__env->slot('thead', null, []); ?> 
                <th>#</th>
                <th width="35%"><?php echo app('translator')->get('Sub-Category Name'); ?></th>
                <th class="text-right"><?php echo app('translator')->get('app.action'); ?></th>
             <?php $__env->endSlot(); ?>

            <?php $__empty_1 = true; $__currentLoopData = $projectSubCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<script>
    ...
    $('#addProjectSubCategory').click(function () {
        var url = "<?php echo e(route('project-settings.createSubCategory')); ?>";
        $(MODAL_LG + ' ' + MODAL_HEADING).html('...');
        $.ajaxModal(MODAL_LG, url);
    });
    $('#importProjectSubCategory').click(function () {
        var url = "<?php echo e(route('project-settings.importSubCategory')); ?>";
        $(MODAL_LG + ' ' + MODAL_HEADING).html('...');
        $.ajaxModal(MODAL_LG, url);
    });
    $('.editProjectCategory').click(function () {
        ...
        var url = "<?php echo e(route('projectSubCategory.edit', ':id')); ?>";
    ...
    $('body').on('click', '.delete-project-category', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var url = "<?php echo e(route('projectSubCategory.destroy', ':id')); ?>";
                url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/project-settings/ajax/sub-category.blade.php ENDPATH**/ ?>