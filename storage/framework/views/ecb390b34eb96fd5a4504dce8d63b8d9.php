...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'xlsx','fieldLabel' => __('Upload File (file must be a file of type:  xlsx)'),'fieldName' => 'file','fieldId' => 'file','popover' => ('messages.fileFormat.ImageFile'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $('#save-project-subcategory').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('project-settings.importProjectSubCategory')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/project-settings/import-project-sub-category-settings-modal.blade.php ENDPATH**/ ?>