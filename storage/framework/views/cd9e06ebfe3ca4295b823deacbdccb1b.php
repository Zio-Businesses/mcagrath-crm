...
<?php endif; ?>
        ...
        <div class="col-lg-12 linkedinSection mb-3 <?php if($credentials->linkedin_status !== 'enable'): ?> d-none <?php endif; ?>">
            <div class="row">
                <div class="col-lg-6">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save_linkedin_data','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/social-login-settings/ajax/linkedin.blade.php ENDPATH**/ ?>