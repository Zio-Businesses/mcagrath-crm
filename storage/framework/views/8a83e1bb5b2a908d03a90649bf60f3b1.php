...
<?php $component->withAttributes(['id' => 'editStatus','class' => 'ajax-form']); ?>
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.edit'); ?> <?php echo app('translator')->get('modules.deal.pipeline'); ?></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'type','fieldLabel' => __('app.name'),'fieldName' => 'name','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.status'),'fieldValue' => $pipeline->name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                        <input type="text" name="label_color" id="colorselector" value="<?php echo e($pipeline->label_color); ?>"
...
<?php endif; ?>
        <?php if(!$pipeline->default && ($deletePipelinePermission == 'all'
...
<script>
    ...
    $('#colorpicker').colorpicker({"color": "<?php echo e($pipeline->label_color); ?>"});
    ...
    $('#save-status').click(function() {
        $.easyAjax({
            url: "<?php echo e(route('lead-pipeline-setting.update', $pipeline->id)); ?>",
    ...
    $('body').on('click', '.delete-pipeline', function() {
            var id = <?php echo e($pipeline->id); ?>;
            Swal.fire({
                title: "<?php echo app('translator')->get('messages.sweetAlertTitle'); ?>",
                text: "<?php echo app('translator')->get('messages.deal.deletePipeline', ['stages' => $pipeline->stages->count(), 'deals' => $pipeline->deals->count()]); ?>",
                icon: 'warning',
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\lead-settings\edit-pipeline-modal.blade.php ENDPATH**/ ?>