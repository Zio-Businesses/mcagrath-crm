...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('tickets.show', $notification->data['ticket_number']),'image' => $notificationUser->image_url,'title' => __('email.newTicketRequester.subject') . ' #' . $notification->data['ticket_number'],'text' => $notification->data['subject'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/new_ticket_requester.blade.php ENDPATH**/ ?>