<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.client.clientCategory'); ?></h5>
...
<?php $component->withAttributes(['class' => 'table-bordered client-cat-table']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($category->id); ?>">
                ...
                <td data-row-id="<?php echo e($category->id); ?>" contenteditable="true"><?php echo e($category->category_name); ?>
...
<script>
    $('.delete-category').click(function() {
        ...
        var url = "<?php echo e(route('clientCategory.destroy', ':id')); ?>";
    ...
    $('#save-category').click(function() {
        var url = "<?php echo e(route('clientCategory.store')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('.client-cat-table [contenteditable=true]').focus(function() {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            var url = "<?php echo e(route('clientCategory.update', ':id')); ?>";
            url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/clients/create_category.blade.php ENDPATH**/ ?>