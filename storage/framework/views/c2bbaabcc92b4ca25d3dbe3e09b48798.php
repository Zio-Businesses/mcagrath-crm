...
<?php $component->withAttributes(['id' => 'save-department-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.menu.editDepartment'); ?></h4>
                <div class="row p-20">
                    <div class="col-md-6">
                        <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'team_name','fieldLabel' => __('app.name'),'fieldName' => 'team_name','fieldRequired' => 'true','fieldValue' => ''.e($department->team_name).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'my-3 mt-2','fieldName' => 'parent_label']); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                            <select class="form-control select-picker mt" name="parent_id" id="parent_id"
                                ...
                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>" <?php if($department->parent_id == $item->id): ?> selected <?php endif; ?>><?php echo e($item->team_name); ?></option>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-department-form').click(function() {
            ...
            const url = "<?php echo e(route('departments.update', $department->id)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/departments/ajax/edit.blade.php ENDPATH**/ ?>