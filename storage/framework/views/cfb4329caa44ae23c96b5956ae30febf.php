...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.name'),'fieldName' => 'name','fieldId' => 'name','fieldPlaceholder' => '','fieldRequired' => 'true','fieldValue' => $deal->name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'editPipeline','fieldLabel' => __('modules.deal.pipeline'),'fieldName' => 'pipeline','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $leadPipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($pipeline->id == $deal->lead_pipeline_id): echo 'selected'; endif; ?> value="<?php echo e($pipeline->id); ?>">
...
<?php $component->withAttributes([]); ?>
                            <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($stage->id == $deal->pipeline_stage_id): echo 'selected'; endif; ?> value="<?php echo e($stage->id); ?>">
...
<?php $component->withAttributes([]); ?>
                                <select class="form-control select-picker" name="category_id" id="category_id"
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($category->id); ?>" <?php if($deal->category_id == $category->id): ?> selected <?php endif; ?>><?php echo e($category->category_name); ?></option>
...
<?php endif; ?>
                    ...
                    <div class="col-lg-4 col-md-6 mt-4">
                        <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'value','fieldLabel' => __('modules.deal.dealValue')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                             <?php $__env->slot('prepend', null, []); ?> 
                                <span
                                    class="input-group-text f-14"><?php echo e(!is_null($deal->currency_id) ? $deal->currency->currency_code : company()->currency->currency_code); ?> ( <?php echo e(!is_null($deal->currency_id) ? $deal->currency->currency_symbol : company()->currency->currency_symbol); ?> )</span>
                             <?php $__env->endSlot(); ?>
                            <input type="number" name="value" id="value" class="form-control height-35 f-14" value="<?php echo e($deal->value); ?>"/>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcbf9105fd4879d5d6ef9e1f6fe271af7)): ?>
<?php $attributes = $__attributesOriginalcbf9105fd4879d5d6ef9e1f6fe271af7; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'custom-date-picker']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker" data-live-search="true" data-size="8"  name="product_id[]" multiple  id="add-products" title="<?php echo e(__('app.menu.selectProduct')); ?>">
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if(in_array($item->id, $productIds)): echo 'selected'; endif; ?> data-content="<?php echo e($item->name); ?>" value="<?php echo e($item->id); ?>">
...
<?php $component = App\View\Components\UserOption::resolve(['user' => $item,'selected' => ($deal->deal_watcher == $item->id)] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\CustomField::resolve(['fields' => $fields,'model' => $deal] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\ButtonCancel::resolve(['link' => route('deals.index')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-lead-form').click(function() {
            ...
            const tab = "<?php echo e($tab); ?>";
            const url = tab != null ? "<?php echo e(route('deals.update', [$deal->id])); ?>?tab=" + tab : "<?php echo e(route('deals.update', [$deal->id])); ?>";
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\leads\ajax\edit.blade.php ENDPATH**/ ?>