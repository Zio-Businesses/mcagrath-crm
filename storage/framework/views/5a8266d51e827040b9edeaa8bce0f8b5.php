...
<?php $component->withAttributes(['id' => 'save-lead-note-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('modules.deal.dealNoteDetails'); ?></h4>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-lead-note-form').click(function() {
            ...
            const url = "<?php echo e(route('deal-notes.update', $note->id)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/leads/notes/edit.blade.php ENDPATH**/ ?>