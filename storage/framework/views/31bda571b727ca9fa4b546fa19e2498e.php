            ...
            <td>
                <div id="invoiced_to">
                    <?php if(!is_null($invoice->project) && !is_null($invoice->project->client) && !is_null($invoice->project->client->clientDetails)): ?>
                        ...
                        <h3 class="name"><?php echo e($invoice->project->client->clientDetails->company_name); ?></h3>
                        <div class="mb-3">
                        ...
                        <?php if($invoiceSetting->show_gst == 'yes' && !is_null($invoice->project->client->clientDetails->gst_number)): ?>
                            <div> <?php echo app('translator')->get('app.gstIn'); ?>: <?php echo e($invoice->project->client->clientDetails->gst_number); ?> </div>
                        <?php endif; ?>
                    ...
                    <?php if(is_null($invoice->project) && !is_null($invoice->estimate) && !is_null($invoice->estimate->client->clientDetails)): ?>
                        <small><?php echo app('translator')->get("modules.invoices.billedTo"); ?>:</small>
                        <h3 class="name"><?php echo e($invoice->estimate->client->clientDetails->company_name); ?></h3>
                        <div class="mb-3">
                            <b><?php echo app('translator')->get('app.address'); ?> :</b>
                        ...
                        <?php if($invoiceSetting->show_gst == 'yes' && !is_null($invoice->estimate->client->clientDetails->gst_number)): ?>
                            <div> <?php echo app('translator')->get('app.gstIn'); ?>: <?php echo e($invoice->estimate->client->clientDetails->gst_number); ?> </div>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </td>
...
<main>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <th class="qty"><?php echo app('translator')->get("modules.invoices.unitPrice"); ?>
                (<?php echo htmlentities($invoice->currency->currency_code); ?>)
            </th>
            <th class="unit"><?php echo app('translator')->get("modules.invoices.price"); ?> (<?php echo htmlentities($invoice->currency->currency_code); ?>
        ...
        <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($item->type == 'item'): ?>
                <tr style="page-break-inside: avoid;">
                    ...
                    <td class="qty"><h3><?php echo e(number_format((float)$item->unit_price, 2, '.', '')); ?></h3></td>
        ...
        <?php if($invoice->creditNotes()->count() > 0): ?>
            <tr dontbreak="true">
                ...
                <td style="text-align: center"><?php echo e(number_format((float)$invoice->appliedCredits(), 2, '.', '')); ?></td>
            </tr>
        <?php endif; ?>
        <tr dontbreak="true">
            <td colspan="4"><?php echo app('translator')->get("app.totalPaid"); ?></td>
            <td style="text-align: center"><?php echo e(number_format((float)$invoice->getPaidAmount(), 2, '.', '')); ?></td>
        </tr>
        <tr dontbreak="true">
            <td colspan="4"> <?php echo app('translator')->get("app.totalDue"); ?></td>
            <td style="text-align: center"><?php echo e(number_format((float)$invoice->amountDue(), 2, '.', '')); ?></td>
        </tr>
        </tfoot>
    </table>
    <p>&nbsp;</p>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/proposals/pdf/invoice-recurring.blade.php ENDPATH**/ ?>