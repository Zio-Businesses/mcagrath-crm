...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('projects.create').'?default_client='.$client->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 openRightModal','data-redirect-url' => ''.e(route('clients.show', $client->id) . '?tab=projects').'']); ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/clients/ajax/projects.blade.php ENDPATH**/ ?>