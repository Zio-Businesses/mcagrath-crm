    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex justify-content-between action-bar">
            <div class="d-flex" id="table-actions">
                <?php if($addClientNotePermission == 'all'): ?>
...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('client-notes.create').'?client='.user()->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $('#client-notes-table').on('preXhr.dt', function(e, settings, data) {
            ...
            var clientId = '<?php echo e(user()->id); ?>';
    ...
    $('body').on('click', '.delete-table-row', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "<?php echo e(route('client-notes.destroy', ':id')); ?>";
    ...
    const applyQuickAction = () => {
        ...
        var url = "<?php echo e(route('client-notes.apply_quick_action')); ?>?row_ids=" + rowdIds;
    ...
    $('body').on('click', '.ask-for-password', function() {
        ...
        var url = "<?php echo e(route('client_notes.ask_for_password', ':id')); ?>";
    ...
    var getNoteDetail = function(id) {
        ...
        var url = "<?php echo e(route('client-notes.show_verified', ':id')); ?>";
        url = url.replace(':id', id);
        var token = "<?php echo e(csrf_token()); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/clients/notes/index.blade.php ENDPATH**/ ?>