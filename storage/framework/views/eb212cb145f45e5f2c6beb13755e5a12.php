                                        ...
                                        <div id="sortable">
                                            <?php $__currentLoopData = $leadFormFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="row py-3 pt-4 border-bottom">
                                                    ...
                                                    <div
                                                        class="col-md-5"><?php echo e($item->field_display_name); ?></div>
                                                    <div class="col-md-4">
...
<?php $component->withAttributes([]); ?>
                            ...
                            <code>
                                &lt;iframe src="<?php echo e(route('front.lead_form',[company()->hash])); ?>"  frameborder="0" scrolling="yes"  style="display:block; width:100%; height:60vh;">&lt;/iframe&gt;
                            </code>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/leads/lead-form/index.blade.php ENDPATH**/ ?>