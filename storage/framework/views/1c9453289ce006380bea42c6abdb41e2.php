...
<?php endif; ?>
            ...
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                    <a href="<?php echo e(route('time-log-report.index')); ?>" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
                        data-original-title="<?php echo app('translator')->get('app.menu.timeLogReport'); ?>"><i class="side-icon bi bi-list-ul"></i></a>

                    <a href="<?php echo e(route('time-log-consolidated.report')); ?>" class="btn btn-secondary f-14" data-toggle="tooltip"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/reports/timelogs/index.blade.php ENDPATH**/ ?>