<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('Create SOW'); ?></h5>
...
<?php $component->withAttributes([]); ?>
                    ...
                    <?php $__currentLoopData = $sow_title; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category->sow_title); ?>">
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('Description'),'fieldName' => 'description','fieldId' => 'description','fieldRequired' => 'true','fieldPlaceholder' => __('Enter sow description')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-project-sow']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
$(document).ready(function() {
    ...
    $('#save-project-sow').click(function() {
        var url = "<?php echo e(route('sow.store')); ?>";
        $.easyAjax({
            url: url,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/projects/sow/create.blade.php ENDPATH**/ ?>