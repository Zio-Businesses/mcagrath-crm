...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.payments.flutterwaveStatus'),'fieldName' => 'flutterwave_status','fieldId' => 'flutterwave_status','fieldValue' => 'active','checked' => $credentials->flutterwave_status == 'active'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="row <?php if($credentials->flutterwave_status == 'deactive'): ?> d-none <?php endif; ?>" id="flutterwave_details">
        <div class="col-lg-12">
            <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'flutterwave_mode','fieldLabel' => __('app.selectEnvironment'),'fieldName' => 'flutterwave_mode'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <option value="sandbox"
                        <?php if($credentials->flutterwave_mode == 'sandbox'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.sandbox'); ?></option>
                <option value="live"
                        <?php if($credentials->flutterwave_mode == 'live'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.live'); ?></option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-6 flutterwave_live <?php echo e($credentials->flutterwave_mode == 'live' ? '' : 'd-none'); ?>">
            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.payments.flutterwaveKey'),'fieldName' => 'live_flutterwave_key','fieldId' => 'live_flutterwave_key','fieldValue' => $credentials->live_flutterwave_key,'fieldPlaceholder' => __('placeholders.paymentGateway.flutterwaveKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('modules.payments.flutterwaveSecretKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <input type="password" name="live_flutterwave_secret" id="live_flutterwave_secret"
                       ...
                       value="<?php echo e($credentials->live_flutterwave_secret); ?>" autocomplete="off">
...
<?php endif; ?>
        ...
        <div class="col-lg-6 flutterwave_live <?php echo e($credentials->flutterwave_mode == 'live' ? '' : 'd-none'); ?>">
            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.payments.flutterwaveSecretHash'),'fieldName' => 'live_flutterwave_hash','fieldId' => 'live_flutterwave_hash','fieldValue' => $credentials->live_flutterwave_hash,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-6 flutterwave_sandbox <?php echo e($credentials->flutterwave_mode == 'sandbox' ? '' : 'd-none'); ?>">
            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.test') . ' ' . __('modules.payments.flutterwaveKey'),'fieldName' => 'test_flutterwave_key','fieldId' => 'test_flutterwave_key','fieldValue' => $credentials->test_flutterwave_key,'fieldPlaceholder' => __('placeholders.paymentGateway.flutterwaveKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-6 flutterwave_sandbox <?php echo e($credentials->flutterwave_mode == 'sandbox' ? '' : 'd-none'); ?>">
            <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('app.test') . ' ' . __('modules.payments.flutterwaveSecretKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                <input type="password" name="test_flutterwave_secret" id="test_flutterwave_secret"
                       class="form-control height-35 f-14"
                       value="<?php echo e($credentials->test_flutterwave_secret); ?>" autocomplete="off">
                 <?php $__env->slot('preappend', null, []); ?> 
                    <button type="button" data-toggle="tooltip" data-original-title="<?php echo e(__('messages.viewKey')); ?>"
                            class="btn btn-outline-secondary border-grey height-35 toggle-password"><i
                            class="fa fa-eye"></i></button>
...
<?php endif; ?>
        ...
        <div class="col-lg-6 flutterwave_sandbox <?php echo e($credentials->flutterwave_mode == 'sandbox' ? '' : 'd-none'); ?>">
            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.test') . ' ' . __('modules.payments.flutterwaveSecretHash'),'fieldName' => 'test_flutterwave_hash','fieldId' => 'test_flutterwave_hash','fieldValue' => $credentials->test_flutterwave_hash,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-6">
            <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.payments.flutterwaveWebhookSecretHash'),'fieldName' => 'flutterwave_webhook_secret_hash','fieldId' => 'flutterwave_webhook_secret_hash','fieldValue' => $credentials->flutterwave_webhook_secret_hash] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
            ...
            <p class="text-primary">(<?php echo app('translator')->get('messages.addFlutterwaveWebhookUrl'); ?>)</p>
        </div>
    </div>
</div>
<!-- Buttons Start -->
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3 w-100','id' => 'save_flutterwave_data']); ?><?php echo app('translator')->get('app.save'); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/payment-gateway-settings/ajax/flutterwave.blade.php ENDPATH**/ ?>