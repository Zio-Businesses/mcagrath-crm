...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'import-deal-data-form']); ?>
            <div class="add-deal bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.importDeal'); ?></h4>
                <div class="col-sm-12 pt-2">
                    <div class="alert alert-warning" role="alert">
                        <?php echo app('translator')->get('app.importDealExcelInfo'); ?>
                    </div>
                </div>
                <div class="row py-20">
                    <div class="col-md-12">
...
<?php $component = App\View\Components\Forms\File::resolve(['fieldLabel' => __('modules.import.file'),'fieldName' => 'import_file','fieldId' => 'deal_import'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'import-deal-form','class' => 'mr-3']); ?><?php echo app('translator')->get('app.uploadNext'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '#import-deal-form', function () {
            const url = "<?php echo e(route('deals.import.store')); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/deals/ajax/import.blade.php ENDPATH**/ ?>