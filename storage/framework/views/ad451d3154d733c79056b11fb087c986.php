...
<?php endif; ?>
    ...
    <?php if(session('connect_success')): ?>
        <?php if (isset($component)) { $__componentOriginal5194778a3a7b899dcee5619d0610f5cf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5194778a3a7b899dcee5619d0610f5cf = $attributes; } ?>
...
<?php $component->withAttributes(['type' => 'success']); ?>
            <?php echo e(session('connect_success')); ?>
...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('app.status'),'fieldName' => 'status','fieldId' => 'quickbook_status','fieldValue' => '1','checked' => $quickbookSetting->status] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="row <?php if($quickbookSetting->status == 0): ?> d-none <?php endif; ?>" id="paypal_details">
        <div class="col-lg-4">
            <?php if (isset($component)) { $__componentOriginal67cd5dc9866c6185ad92d933c387fa86 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal67cd5dc9866c6185ad92d933c387fa86 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'paypal_mode','fieldLabel' => __('app.selectEnvironment'),'fieldName' => 'environment'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <option value="Development" <?php if($quickbookSetting->environment == 'Development'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.sandbox'); ?></option>
                <option value="Production" <?php if($quickbookSetting->environment == 'Production'): ?> selected <?php endif; ?>><?php echo app('translator')->get('app.live'); ?></option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => 'Client ID','fieldName' => 'sandbox_client_id','fieldId' => 'sandbox_client_id','fieldValue' => $quickbookSetting->sandbox_client_id,'fieldRequired' => 'true','fieldPlaceholder' => ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'sandbox_client_secret','fieldLabel' => 'Client Secret','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                        <input type="password" name="sandbox_client_secret" id="sandbox_client_secret"
                            class="form-control height-35 f-14" value="<?php echo e($quickbookSetting->sandbox_client_secret); ?>">
        ...
        <div
            ...
            <div class="row">
                <div class="col-lg-6">
                    <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => 'Client ID','fieldName' => 'client_id','fieldId' => 'client_id','fieldValue' => $quickbookSetting->client_id,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                ...
                <div class="col-lg-6">
                    <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'client_secret','fieldLabel' => 'Client Secret','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php $component->withAttributes([]); ?>
                        <input type="password" name="client_secret" id="client_secret"
                            class="form-control height-35 f-14" value="<?php echo e($quickbookSetting->client_secret); ?>">
                         <?php $__env->slot('preappend', null, []); ?> 
                            <button type="button" data-toggle="tooltip" data-original-title="<?php echo app('translator')->get('app.viewPassword'); ?>"
                                class="btn btn-outline-secondary border-grey height-35 toggle-password"><i
                                    class="fa fa-eye"></i></button>
...
<?php endif; ?>
        ...
        <div class="col-lg-12">
            <?php if (isset($component)) { $__componentOriginal89b295b0763c93abe0143426334eb5d6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal89b295b0763c93abe0143426334eb5d6 = $attributes; } ?>
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => '','fieldLabel' => __('modules.invoiceSettings.quickbooksRedirectUrl')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php unset($__componentOriginal89b295b0763c93abe0143426334eb5d6); ?>
<?php endif; ?>
            <p class="text-bold"><span id="webhook-link-text"><?php echo e(route('quickbooks.callback', company()->hash)); ?></span>
            ...
            <p class="text-primary">(<?php echo app('translator')->get('modules.invoiceSettings.addQuickbooksRedirectUrl'); ?>)</p>
        </div>

        <?php if($quickbookSetting->access_token == '' || $quickbookSetting->refresh_token == ''): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'danger']); ?>
                    <?php echo app('translator')->get('modules.invoiceSettings.connectQuickBooks'); ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5194778a3a7b899dcee5619d0610f5cf)): ?>
<?php $attributes = $__attributesOriginal5194778a3a7b899dcee5619d0610f5cf; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3','id' => 'save-quickbooks']); ?><?php echo app('translator')->get('app.save'); ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if($quickbookSetting->status): ?>
                <?php if($quickbookSetting->access_token == '' || $quickbookSetting->refresh_token == ''): ?>
                    <a href="<?php echo e(route('quickbooks.index')); ?>"><img src="<?php echo e(asset('img/C2QB_auth.png')); ?>" class="height-35"></a>
                <?php else: ?>
...
<?php $component = App\View\Components\Forms\LinkSecondary::resolve(['icon' => 'key','link' => route('quickbooks.index')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-3']); ?><?php echo app('translator')->get('modules.invoiceSettings.reauthorizeQuickBooks'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
var clipboard = new ClipboardJS('.btn-copy');
    ...
    $('#save-quickbooks').click(function () {
        $.easyAjax({
            url: "<?php echo e(route('quickbooks-settings.update', $quickbookSetting->id)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/invoice-settings/ajax/quickbooks.blade.php ENDPATH**/ ?>