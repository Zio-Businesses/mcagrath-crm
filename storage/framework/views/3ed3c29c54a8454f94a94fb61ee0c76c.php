...
<?php $component = App\View\Components\Cards\Data::resolve(['title' => __('Vendors'),'otherClasses' => 'border-0 p-0 d-flex justify-content-between align-items-center table-responsive-sm'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\xampp\htdocs\public_html\resources\views/projects/ajax/vendors.blade.php ENDPATH**/ ?>