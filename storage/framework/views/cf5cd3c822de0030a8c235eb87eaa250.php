...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.discussions.discussionCategory'); ?></h5>
...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($category->id); ?>">
                ...
                <td>
                    <i class="fa fa-circle" style="color: <?php echo e($category->color); ?>"></i>
                </td>
...
<script>
    ...
    $('.delete-category').click(function () {
        ...
        let url = "<?php echo e(route('discussion-category.destroy', ':id')); ?>";
    ...
    $('#save-category').click(function () {
        const url = "<?php echo e(route('discussion-category.store')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('[contenteditable=true]').focus(function () {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            let url = "<?php echo e(route('discussion-category.update', ':id')); ?>";
            url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/discussions/create_category.blade.php ENDPATH**/ ?>