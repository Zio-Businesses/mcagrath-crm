...
<?php $component->withAttributes(['id' => 'createMethods','class' => 'ajax-form']); ?>
    <div class="modal-header">
        <h5 class="modal-title"><?php echo app('translator')->get('app.addNewofflinePaymentMethod'); ?></h5>
...
<script>
    ...
    $('#save-method').click(function () {
        $.easyAjax({
            url: "<?php echo e(route('offline-payment-setting.store')); ?>",
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\payment-gateway-settings\create-offline-payment-modal.blade.php ENDPATH**/ ?>