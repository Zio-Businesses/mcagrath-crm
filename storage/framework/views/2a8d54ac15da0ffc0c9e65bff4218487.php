...
<?php $component = App\View\Components\Cards\Data::resolve(['title' => __('app.file')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <?php if($addContractFilePermission == 'all' || $addContractFilePermission == 'added'): ?>

            <div class="row">
                <div class="col-md-12">
                    <a class="f-15 f-w-500" href="javascript:;" id="add-task-file"><i
                            class="icons icon-plus font-weight-bold mr-1"></i><?php echo app('translator')->get('modules.lead.addFile'); ?>
                        </a>
                </div>
            </div>
...
<?php endif; ?>
        ...
        <div class="d-flex flex-wrap mt-3" id="task-file-list">
            <?php if($viewContractFilesPermission != 'none'): ?>
...
<script>
    $(document).ready(function() {
        var add_task_files = "<?php echo e($addContractFilePermission); ?>";
        if (add_task_files == "all" || add_task_files == "added") {
            ...
            taskDropzone = new Dropzone("div#task-file-upload-dropzone", {
                ...
                url: "<?php echo e(route('contractFiles.store')); ?>",
                headers: {
            ...
            taskDropzone.on('sending', function(file, xhr, formData) {
                var ids = "<?php echo e($contract->id); ?>";
        ...
        $('#task-file-list').on('click', '.delete-file', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('contractFiles.destroy', ':id')); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/contracts/ajax/files.blade.php ENDPATH**/ ?>