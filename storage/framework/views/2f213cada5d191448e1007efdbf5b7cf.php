...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">
        <?php if($type=='digitalocean'): ?>
            <?php echo app('translator')->get('app.storageSetting.testDigitaloceanSetting'); ?>
        <?php elseif($type=='wasabi'): ?>
            <?php echo app('translator')->get('app.storageSetting.testwasabiSetting'); ?>
        <?php else: ?>
            <?php echo app('translator')->get('app.storageSetting.testAWSSetting'); ?>
        <?php endif; ?>
    </h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'StorageUploadForm','class' => 'ajax-form']); ?>
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'txt pdf doc xls xlsx docx rtf png jpg jpeg svg','fieldLabel' => __('app.storageSetting.uploadFile'),'fieldName' => 'file','fieldId' => 'file','popover' => __('messages.fileFormat.multipleImageFile')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    <a href="javascript:;" id="show-file" class="d-none"><?php echo app('translator')->get('app.storageSetting.viewFile'); ?></a>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-xs mr-3 d-none','id' => 'show-file']); ?>
        <?php echo app('translator')->get('app.storageSetting.viewFile'); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'test-aws-submit']); ?><?php echo app('translator')->get('app.submit'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#test-aws-submit').click(function () {
        $.easyAjax({
            url: "<?php echo e(route('storage-settings.aws_test')); ?>",
            ...
            success: function (response) {
                if (response.status === "success") {
                    $('.alert-success').append(` <a href="${response.fileurl}" target="_blank"><?php echo app('translator')->get('app.storageSetting.viewFile'); ?> </a>`);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/storage-settings/test-s3-upload.blade.php ENDPATH**/ ?>