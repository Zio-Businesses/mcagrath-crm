...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createCurrencyKey']); ?>
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.accountSettings.currencyConverterKey'); ?></h5>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="alert alert-info ">
                    <i class="fa fa-info-circle"></i> <?php echo app('translator')->get('messages.currencyConvertApiKeyUrl'); ?> <a
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'password','fieldLabel' => __('modules.accountSettings.currencyConverterKey'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                    <input type="password" name="currency_converter_key" id="currency_converter_key"
                           ...
                           value="<?php echo e(!is_null(global_setting()->currency_converter_key) ? global_setting()->currency_converter_key : ''); ?>">
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'country','fieldLabel' => 'Version','fieldName' => 'currency_key_version'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <option <?php echo e((global_setting()->currency_key_version == 'free' ? 'selected' : '')); ?> value="free">
                        Free
                    </option>
                    <option <?php echo e((global_setting()->currency_key_version == 'paid' ? 'selected' : '')); ?> value="paid">
                        Paid
                    </option>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-currency']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $('#save-currency').click(function () {
        $.easyAjax({
            url: "<?php echo e(route('currency_settings.exchange_key_store')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/currency-settings/currency-exchange-modal.blade.php ENDPATH**/ ?>