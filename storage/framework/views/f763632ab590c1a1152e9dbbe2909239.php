                    ...
                    <?php if($invoiceSetting->hsn_sac_code_show): ?>
                        <td class="border-bottom-0">
                            <input type="text" min="1" class="form-control f-14 border-0 w-100 text-right hsn_sac_code"
                                data-item-id="<?php echo e($items->id); ?>" value="<?php echo e($items->hsn_sac_code); ?>" name="hsn_sac_code[]">
                        </td>
                    <?php endif; ?>
                    <td class="border-bottom-0">
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/proposal-template/ajax/add_item.blade.php ENDPATH**/ ?>