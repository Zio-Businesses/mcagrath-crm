...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.contracts.contractType'); ?></h5>
...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($category->id); ?>">
                ...
                <td data-row-id="<?php echo e($category->id); ?>" contenteditable="true"><?php echo e($category->name); ?></td>
                <td class="text-right">
                    <?php if($manageTypePermission == 'all' || $manageTypePermission == 'added'): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createContractTypeForm']); ?>
        <div class="row border-top-grey ">
            <div class="col-sm-12">
                <?php if (isset($component)) { $__componentOriginal4e45e801405ab67097982370a6a83cba = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4e45e801405ab67097982370a6a83cba = $attributes; } ?>
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'category_name','fieldLabel' => __('app.name'),'fieldName' => 'name','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.category')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-contract-type']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $('.delete-category').click(function() {
        ...
        var url = "<?php echo e(route('contractTypes.destroy', ':id')); ?>";
    ...
    $('#save-contract-type').click(function() {
        var url = "<?php echo e(route('contractTypes.store')); ?>";
        $.easyAjax({
            url: url,
    ...
    $('[contenteditable=true]').focus(function() {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            var url = "<?php echo e(route('contractTypes.update', ':id')); ?>";
            url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/contracts/types/create.blade.php ENDPATH**/ ?>