<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.clients.addShippingAddress'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addShippingAddress']); ?>
        <div class="row">
            <div class="col-lg-12">
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('modules.clients.shippingAddress'),'fieldName' => 'shipping_address','fieldId' => 'shipping_address','fieldPlaceholder' => __('placeholders.address'),'fieldValue' => ''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-shipping-address']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $('#save-shipping-address').click(function() {
        ...
        var url = "<?php echo e(route('invoices.add_shipping_address', $clientId)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/sections/add_shipping_address.blade.php ENDPATH**/ ?>