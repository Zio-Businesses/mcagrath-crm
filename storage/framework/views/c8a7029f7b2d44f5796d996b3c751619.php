...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('tickets.show', $notification->data['id']),'image' => user()->image_url,'title' => __('email.ticketAgent.subject') . ' #' . $notification->data['id'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/ticket_agent.blade.php ENDPATH**/ ?>