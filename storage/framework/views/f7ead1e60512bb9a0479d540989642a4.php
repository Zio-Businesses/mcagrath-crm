            ...
            <div class="select-status">
                <select class="form-control select-picker" name="status" id="status">
                    ...
                    <?php $__currentLoopData = $taskBoardStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                            value="<?php echo e($status->id); ?>"><?php echo e($status->slug == 'completed' || $status->slug == 'incomplete' ? __('app.' . $status->slug) : $status->column_name); ?></option>
...
<?php endif; ?>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 text-capitalize"
                       for="usr"><?php echo app('translator')->get('modules.tasks.assignTo'); ?></label>
                <div class="select-filter mb-4">
                    <div class="select-others">
...
<?php endif; ?>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 text-capitalize"
                       for="usr"><?php echo app('translator')->get('modules.tasks.assignBy'); ?></label>
                <div class="select-filter mb-4">
                    <div class="select-others">
...
<?php endif; ?>
            ...
            <div class="btn-group" role="group">
                <a href="<?php echo e(route('tasks.index')); ?>" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
                ...
                <a href="<?php echo e(route('taskboards.index')); ?>" class="btn btn-secondary f-14" data-toggle="tooltip"
                   data-original-title="<?php echo app('translator')->get('modules.tasks.taskBoard'); ?>"><i
    ...
    <script>
        $('#allTasks-table').on('preXhr.dt', function (e, settings, data) {
            ...
            if (startDate == '') {
                ...
                startDate = dateRangePicker.startDate.format('<?php echo e($company->moment_format); ?>');
                endDate = dateRangePicker.endDate.format('<?php echo e($company->moment_format); ?>');
            }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/front/tasks/index.blade.php ENDPATH**/ ?>