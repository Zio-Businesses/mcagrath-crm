    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="form-group my-3">
                <label class="f-14 text-dark-grey mb-12 w-100" for="usr"><?php echo app('translator')->get('modules.gdpr.enableCustomerToExportData'); ?></label>
                <div class="d-flex">
...
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'yes1','fieldLabel' => __('app.yes'),'fieldName' => 'enable_export','fieldValue' => '1','checked' => $gdprSetting->enable_export == 1] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginalc709ddc147ddde534205d9546b4fb0db = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc709ddc147ddde534205d9546b4fb0db = $attributes; } ?>
<?php $component = App\View\Components\Forms\Radio::resolve(['fieldId' => 'no1','fieldLabel' => __('app.no'),'fieldValue' => '0','fieldName' => 'enable_export','checked' => $gdprSetting->enable_export == 0] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.radio'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Radio::class))->getConstructor()): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-right-to-data-portability']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<!-- Buttons End -->
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\gdpr-settings\ajax\right-to-data-portability.blade.php ENDPATH**/ ?>