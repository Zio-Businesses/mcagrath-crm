<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('Add Locations'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'createLocations','class' => 'ajax-form']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-locations']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-locations').click(function () {
        $.easyAjax({
            container: '#createLocations',
            type: "POST",
            file: true,
            disableButton: true,
            // blockUI: true,
            buttonSelector: "#save-locations",
            url: "<?php echo e(route('location.importStore')); ?>",
            data: $('#createLocations').serialize(),
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/app-settings/import-location-settings-modal.blade.php ENDPATH**/ ?>