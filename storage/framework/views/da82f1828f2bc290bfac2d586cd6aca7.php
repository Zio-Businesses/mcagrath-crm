...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
             <?php $__env->slot('thead', null, []); ?> 
                <th>#</th>
                <th width="35%"><?php echo app('translator')->get('Priority Name'); ?></th>
                <th class="text-right"><?php echo app('translator')->get('app.action'); ?></th>
             <?php $__env->endSlot(); ?>

            <?php $__empty_1 = true; $__currentLoopData = $projectPriority; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<script>
    ...
    $('#addProjectPriority').click(function () {
        var url = "<?php echo e(route('project-settings.createPriority')); ?>";
    ...
    $('.editProjectTask').click(function () {
        ...
        var url = "<?php echo e(route('projectPriority.edit', ':id')); ?>";
    ...
    $('body').on('click', '.delete-project-task', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var url = "<?php echo e(route('projectPriority.destroy', ':id')); ?>";
                url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/project-settings/ajax/priority.blade.php ENDPATH**/ ?>