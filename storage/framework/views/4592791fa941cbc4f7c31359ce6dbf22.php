...
<div id="container">
    <div class="invoice-top">
            ...
            <div class="company-info">
                ...
                <div>
                    <?php if(!is_null($settings) && $order->address): ?>
                        <?php echo nl2br($order->address->address); ?>
                ...
                <div><?php echo e(company()->company_phone); ?>
        ...
        <section id="invoice-info">
            <table>
                <tr>
                    <td><?php echo app('translator')->get('modules.orders.orderDate'); ?>:</td>
                    <td><?php echo e(\Carbon\Carbon::parse($order->order_date)->translatedFormat(company()->date_format)); ?></td>
                </tr>
                <tr>
                    <td><?php echo app('translator')->get('app.status'); ?>:</td>
                    <td><?php echo app('translator')->get('modules.invoices.'.$order->status); ?></td>
                </tr>
            ...
            <section id="invoice-title-number">
                ...
                <span id="number"><?php echo e($order->order_number); ?></span>
        ...
        <?php if($order->client && $order->clientDetails): ?>
            <section id="client-info">
                <?php if(($order->client->name || $order->client->email || $order->client->mobile || $order->clientDetails->company_name || $order->clientDetails->address )
                    ...
                    <?php if($order->client->clientDetails->address && $invoiceSetting->show_client_company_address == 'yes'): ?>
                        <div>
                            ...
                            <span><?php echo nl2br($order->clientDetails->address); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if($order->show_shipping_address == 'yes' && $order->client->clientDetails->address && $invoiceSetting->show_client_company_address == 'yes'): ?>
                        <div class="mb-3">
                            <b><?php echo app('translator')->get('app.address'); ?> :</b>
                ...
                <?php if($order->show_shipping_address === 'yes'): ?>
                    <div>
    ...
    <div class="invoice-body">
        <section id="items">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th class="qty"> </th>
                    <?php endif; ?>
                    <th><?php echo app('translator')->get("app.sku"); ?></th>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="<?php echo e($invoiceSetting->hsn_sac_code_show ? '6' : '5'); ?>"><?php echo app('translator')->get("modules.invoices.subTotal"); ?>:</td>
                    <td><?php echo e(currency_format($order->sub_total, $order->currency_id, false)); ?></td>
                </tr>
                <?php if($discount != 0 && $discount != ''): ?>
                <tr data-iterate="tax">
                    <td colspan="<?php echo e($invoiceSetting->hsn_sac_code_show ? '6': '5'); ?>"><?php echo app('translator')->get("modules.invoices.discount"); ?>:</td>
                ...
                <tr data-iterate="tax">
                    <td colspan="<?php echo e($invoiceSetting->hsn_sac_code_show ? '6': '5'); ?>"><?php echo e($key); ?>:</td>
        ...
        <section id="terms">
            <?php if(!is_null($order->note)): ?>
                <div class="word-break item-summary"><?php echo nl2br($order->note); ?></div>
            <?php endif; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/orders/pdf/invoice-2.blade.php ENDPATH**/ ?>