...
<?php $component->withAttributes(['id' => 'save-project-note-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.projectNoteDetails'); ?></h4>
...
<?php endif; ?>
                ...
                <div class="row p-20 <?php if($note->type == 0): ?> d-none <?php endif; ?>" id="private-note-details">
...
<script>
    $(document).ready(function() {
        ...
        const atValues = <?php echo json_encode($projectuserData, 15, 512) ?>;
        ...
        $('#save-project-note-form').click(function() {
            ...
            const url = "<?php echo e(route('project-notes.update', $note->id)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/projects/notes/edit.blade.php ENDPATH**/ ?>