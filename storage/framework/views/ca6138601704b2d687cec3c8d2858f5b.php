<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('Add Vendor Leads'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'importVendors','class' => 'ajax-form']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-vendorleads']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-vendorleads').click(function () {
        $.easyAjax({
            ...
            url: "<?php echo e(route('vendortrack.importStore')); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendortrack/import-vendor-lead-modal.blade.php ENDPATH**/ ?>