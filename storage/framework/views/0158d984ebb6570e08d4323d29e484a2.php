...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('client-contacts.create').'?client='.$client->id,'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 openRightModal']); ?>
                        <?php echo app('translator')->get('modules.contacts.addContact'); ?>
...
<script>
    ...
    $('body').on('click', '.delete-table-row', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "<?php echo e(route('client-contacts.destroy', ':id')); ?>";
    ...
    const applyQuickAction = () => {
        ...
        var url = "<?php echo e(route('client-contacts.apply_quick_action')); ?>?row_ids=" + rowdIds;
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/clients/ajax/contacts.blade.php ENDPATH**/ ?>