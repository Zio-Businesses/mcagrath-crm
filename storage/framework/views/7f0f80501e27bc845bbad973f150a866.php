...
<?php $component->withAttributes([]); ?>
    ...
    <?php if($viewInvoiceFilePermission == 'all' || ($viewInvoiceFilePermission == 'added' && $file->added_by == user()->id)): ?>
         <?php $__env->slot('action', null, []); ?> 
            <div class="dropdown ml-auto file-action">
                ...
                <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                    ...
                    <?php if($deleteInvoiceFilePermission == 'all' || ($deleteInvoiceFilePermission == 'added' && $file->added_by == user()->id)): ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/invoices/files/show.blade.php ENDPATH**/ ?>