...
<head>
    ...
    <?php if ($__env->exists('estimates-vendor.pdf.estimate_pdf_css')) echo $__env->make('estimates-vendor.pdf.estimate_pdf_css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <style>
        .bg-grey {
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="f-14 text-black">
                                ...
                                <?php echo e($estimate->vendors->vendor_name); ?><br>
                                <?php echo e($estimate->vendors->vendor_email); ?><br>
                                <?php echo e($estimate->vendors->cell); ?><br>
                                <?php echo e($estimate->vendors->company_name); ?><br>
                                <?php echo e($estimate->vendors->street_address); ?>
                            ...
                            <td align="right">
                                <br />
                                <?php if($estimate->vendors->company_logo): ?>
                                    <img src="<?php echo e($estimate->vendors->image_url); ?>"
                                        alt="<?php echo e($estimate->vendors->company_name); ?>" class="logo"
                                        style="height:50px;" />
                                    <br><br><br>
                                <?php endif; ?>
                            </td>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/estimates-vendor/pdf/invoice-5.blade.php ENDPATH**/ ?>