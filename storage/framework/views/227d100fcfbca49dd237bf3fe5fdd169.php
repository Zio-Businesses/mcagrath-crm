            ...
            <div class="col-md-3">
                <div class="form-group mb-lg-0 mb-md-0 mb-4">
                    <label class="f-14 text-dark-grey mb-12 text-capitalize"
                        for="usr"><?php echo app('translator')->get('app.credit-note'); ?> #</label>
                    <div class="input-group">
                        ...
                        <input type="text" name="cn_number" id="cn_number" class="form-control height-35 f-15 readonly-background" readonly value="<?php if(is_null($lastCreditNote)): ?>1 <?php else: ?><?php echo e($lastCreditNote); ?><?php endif; ?>" placeholder="0019" aria-label="0019" aria-describedby="basic-addon1">
                    </div>
                </div>
            </div>
            <!-- INVOICE NUMBER END -->
...
<?php endif; ?>
                    <div class="input-group">
                        <input type="text" id="invoice_date" name="issue_date"
                            ...
                            value="<?php echo e($creditNote->issue_date ? $creditNote->issue_date->translatedFormat(company()->date_format) : ''); ?>">
                    </div>
                </div>
            </div>
            <!-- INVOICE DATE END -->
...
<?php endif; ?>
                    <div class="input-group ">
                        <input type="text" id="due_date" name="due_date"
                            class="px-6 position-relative text-dark font-weight-normal form-control height-35 rounded p-0 text-left f-15"
                            placeholder="<?php echo app('translator')->get('placeholders.date'); ?>"
                            value="<?php echo e($creditNote->due_date ? $creditNote->due_date->translatedFormat(company()->date_format) : ''); ?>">
                    </div>
                </div>
            </div>
            <!-- DUE DATE END -->
                    ...
                    <div class="select-others height-35 rounded">
                        <select class="form-control select-picker" name="currency_id" id="currency_id">
                            <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                <?php if($creditNote->currency_id == $currency->id): ?> selected <?php endif; ?>
                            ...
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span id="discount_amount"><?php echo e(number_format((float)$creditNote->discount, 2, '.', '')); ?></span></td>
                                    </tr>
                                    <tr>
...
<script>
    $(document).ready(function() {
        ...
        const dp2 = datepicker('#due_date', {
            position: 'bl',
            dateSelected: new Date("<?php echo e(str_replace('-', '/', $creditNote->due_date)); ?>"),
            ...datepickerConfig
        });
                            ...
                            +'<tr class="text-dark-grey font-weight-bold f-14">'
                                ...
                                +'<tr>'
                                    +'<td class="border-bottom-0 btrr-mbl btlr">'
                                        ...
                                        +'</td>'
                                        +'<td class="border-bottom-0 d-block d-lg-none d-md-none">'
                                            +`<input type="text" class="form-control f-14 border-0 w-100 mobile-description" name="item_summary[]" placeholder="<?php echo app('translator')->get('placeholders.invoices.description'); ?>">`
                                        +'</td>'
                                        +'<td class="border-bottom-0">'
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/credit-notes/convert_invoice.blade.php ENDPATH**/ ?>