...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('app.name'),'fieldName' => 'name','fieldId' => 'name','fieldPlaceholder' => __('placeholders.name'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                                                ...
                                                <select id="multiselect" name="taxes[<?php echo e($key); ?>][]"
                                                    ...
                                                    <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option data-rate="<?php echo e($tax->rate_percent); ?>" data-tax-text="<?php echo e($tax->tax_name .':'. $tax->rate_percent); ?>%"
                                                            <?php if(isset($item->taxes) && array_search($tax->id, json_decode($item->taxes)) !== false): ?> selected <?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        function addProduct(id) {
            ...
            $.easyAjax({
                url: "<?php echo e(route('estimate-template.add_item')); ?>",
                type: "GET",
                data: {
                    id: id,
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "<?php echo e(route('estimate-template.store')); ?>",
                container: '#saveInvoiceForm',
                type: "POST",
                blockUI: true,
                redirect: true,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/estimates-templates/ajax/create.blade.php ENDPATH**/ ?>