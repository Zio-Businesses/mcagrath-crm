                            ...
                            <select class="form-control select-picker" name="category_id" id="task_category_id"
                                ...
                                <?php if($viewTaskCategoryPermission == 'all' || $viewTaskCategoryPermission == 'added'): ?>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($task->task_category_id == $category->id): echo 'selected'; endif; ?> value="<?php echo e($category->id); ?>">
...
<?php $component->withAttributes([]); ?>
                            <select class="form-control select-picker" name="project_id" id="project-id"
                                    data-toggle="tooltip"
                                    title="<?php echo app('translator')->get('modules.tasks.notFinishedProjects'); ?>"
                                data-live-search="true" data-size="8">
                                <option value="">--</option>
                                <?php if($viewProjectPermission != 'none' && in_array('employee', user_roles())): ?>
                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($project->id == $task->project_id): echo 'selected'; endif; ?> value="<?php echo e($project->id); ?>"
                                            data-content="<?php echo '<strong>'.$project->project_short_code."</strong> ".$project->project_name; ?>"
                                    >
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-12 show-leave">
                        <?php if(isset($leaveData)): ?>
                            <label id="leave-date"> <?php echo e(__("modules.tasks.leaveMessage")); ?> <i class="fa fa-question-circle" title="<?php echo e($leaveData); ?>" id="leave-tooltip"></i></label>
                        <?php endif; ?>
                    </div>
...
<?php $component->withAttributes([]); ?>
                                    <option value="">--</option>
                                    <?php if($task->project && count($task->project->incompleteMilestones) > 0): ?>
                                        <?php $__currentLoopData = $task->project->incompleteMilestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php if($milestone->id == $task->milestone_id): echo 'selected'; endif; ?> value="<?php echo e($milestone->id); ?>">
...
<?php $component->withAttributes([]); ?>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                            <option <?php if($task->board_column_id == $item->id): echo 'selected'; endif; ?> value="<?php echo e($item->id); ?>" data-content = "<?php echo e($icon); ?>">
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <option <?php if($task->priority == 'high'): echo 'selected'; endif; ?>
                                    ...
                                    <option <?php if($task->priority == 'medium'): echo 'selected'; endif; ?>
                                    ...
                                    <option <?php if($task->priority == 'low'): echo 'selected'; endif; ?>
                                        ...
                                        <input type="number" min="1" value="<?php echo e($task->repeat_count); ?>" name="repeat_count"
                                         ...
                                         <?php $__env->slot('append', null, []); ?> 
                                            <select name="repeat_type" class="select-picker form-control">
                                                <option <?php if($task->repeat_type == 'day'): echo 'selected'; endif; ?> value="day">
                                                    <?php echo app('translator')->get('app.day'); ?></option>
                                                <option <?php if($task->repeat_type == 'week'): echo 'selected'; endif; ?> value="week">
                                                    <?php echo app('translator')->get('app.week'); ?></option>
                                                <option <?php if($task->repeat_type == 'month'): echo 'selected'; endif; ?> value="month">
                                                    <?php echo app('translator')->get('app.month'); ?></option>
                                                <option <?php if($task->repeat_type == 'year'): echo 'selected'; endif; ?> value="year">
...
<?php $component->withAttributes([]); ?>
                                ...
                                <?php $__currentLoopData = $allTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($item->id == $task->dependent_task_id): echo 'selected'; endif; ?> value="<?php echo e($item->id); ?>">
                                        <?php echo e($item->heading); ?>

                                        (<?php echo app('translator')->get('app.dueDate'); ?>:
                                        <?php if(!is_null($item->due_date)): ?>
                                            <?php echo e($item->due_date->translatedFormat(company()->date_format)); ?>)
                                        <?php endif; ?>
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             <?php echo $__env->renderComponent(); ?>
...
<?php $component = App\View\Components\Forms\FileMultiple::resolve(['fieldLabel' => __('app.menu.addFile'),'fieldName' => 'file','fieldId' => 'task-files-upload-dropzone'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                ...
                $.easyAjax({
                    ...
                    var leaveData = [];
                        ...
                        $.each(rData, function(index, value) {
                            ...
                            leaveData.push(data);
                            var label = '<label id="leave-date"> <?php echo e(__("modules.tasks.leaveMessage")); ?> <i class="fa fa-question-circle" title="'+leaveData+'" id="leave-tooltip"></i></label>'
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/tasks/ajax/edit.blade.php ENDPATH**/ ?>