...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'update-employee-file-data-form']); ?>
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.editFile'); ?></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.projects.fileName'),'fieldName' => 'name','fieldRequired' => 'true','fieldId' => 'name','fieldValue' => $file->name] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\File::resolve(['fieldLabel' => __('modules.projects.uploadFile'),'fieldName' => 'file','fieldRequired' => 'true','fieldId' => 'file','allowedFileExtensions' => 'txt pdf doc xls xlsx docx rtf png jpg jpeg svg','popover' => __('messages.fileFormat.multipleImageFile'),'fieldValue' => $file->doc_url] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '#submit-document', function () {
            var url = "<?php echo e(route('employee-docs.update', $file->id)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/employees/files/edit.blade.php ENDPATH**/ ?>