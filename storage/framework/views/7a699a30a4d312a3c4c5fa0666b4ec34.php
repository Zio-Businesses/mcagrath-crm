...
<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.editVisa'); ?></h5>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-visa-data-form','class' => 'ajax-form']); ?>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.employees.visaNumber'),'fieldName' => 'visa_number','fieldId' => 'visa_number','fieldValue' => $visa->visa_number ?? '' ,'fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'country','fieldLabel' => __('app.country'),'fieldName' => 'country','search' => 'true','fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                        ...
                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($visa->country_id == $item->id): ?> selected <?php endif; ?> data-tokens="<?php echo e($item->iso3); ?>" data-content="<span
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg pdf doc docx','fieldLabel' => __('modules.employees.scanCopy'),'fieldName' => 'file','fieldValue' => $visa->file ? $visa->image_url : '' ,'fieldId' => 'file'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-visa-form']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-visa-form').click(function(){
        $.easyAjax({
            url: "<?php echo e(route('employee-visa.update', $visa->id)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/employees/ajax/edit-visa-modal.blade.php ENDPATH**/ ?>