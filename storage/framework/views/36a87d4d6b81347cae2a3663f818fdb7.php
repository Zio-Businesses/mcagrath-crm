<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.projects.uploadFile'); ?></h5>
...
<?php $component->withAttributes(['id' => 'createTaskCategory']); ?>
        <input type="hidden" name="credit_note_id" value="<?php echo e($creditNoteId); ?>">
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'txt pdf doc xls xlsx docx rtf png jpg jpeg svg','fieldLabel' => __('modules.projects.uploadFile'),'fieldName' => 'file','fieldId' => 'credit-file','popover' => __('messages.fileFormat.multipleImageFile')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $('#save-category').click(function() {
        var url = "<?php echo e(route('creditnotes.store_file')); ?>";
        $.easyAjax({
            url: url,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/credit-notes/file_upload.blade.php ENDPATH**/ ?>