...
<?php $component->withAttributes(['id' => 'save-vendor-note-data-form']); ?>
            <div class="add-client bg-white rounded">
                ...
                <input type="hidden" name="vendors_id" value="<?php echo e($vendors->id); ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('#save-vendor-note-form').click(function() {
            ...
            const url = "<?php echo e(route('vendor-module-notes.store')); ?>";
            $.easyAjax({
                url: url,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendors/notes/create.blade.php ENDPATH**/ ?>