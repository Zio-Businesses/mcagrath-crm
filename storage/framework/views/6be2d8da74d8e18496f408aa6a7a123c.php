...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr id="cat-<?php echo e($subcategory->id); ?>">
                ...
                <td class="text-right">
                    <?php if($deleteClientSubCategoryPermission == 'all' || $deleteClientSubCategoryPermission == 'added'): ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'category_id','fieldLabel' => __('modules.client.clientCategory'),'fieldName' => 'category_id','search' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/employees/create-subcategory.blade.php ENDPATH**/ ?>