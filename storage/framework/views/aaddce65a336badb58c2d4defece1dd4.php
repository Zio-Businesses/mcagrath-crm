...
<?php $component = App\View\Components\Cards\Notification::resolve(['notification' => $notification,'link' => route('projects.show', $notification->data['id']),'image' => user()->image_url,'title' => __('email.newProjectStatus.subject'),'text' => $notification->data['project_name'],'time' => $notification->created_at] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/notifications/all/new_project_status.blade.php ENDPATH**/ ?>