...
<?php $component->withAttributes(['class' => 'table-bordered']); ?>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $projectType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<script>
    ...
    $('#addProjectType').click(function () {
        var url = "<?php echo e(route('project-settings.createType')); ?>";
    ...
    $('.editProjectTask').click(function () {
        ...
        var url = "<?php echo e(route('projectType.edit', ':id')); ?>";
    ...
    $('body').on('click', '.delete-project-task', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var url = "<?php echo e(route('projectType.destroy', ':id')); ?>";
                url = url.replace(':id', id);
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/project-settings/ajax/type.blade.php ENDPATH**/ ?>