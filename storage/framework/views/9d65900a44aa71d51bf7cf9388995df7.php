...
<div class="modal-header">
    <h5 class="modal-title"><?php echo app('translator')->get('app.editPassport'); ?></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.employees.passportNumber'),'fieldName' => 'passport_number','fieldId' => 'passport_number','fieldValue' => $passport->passport_number ?? '' ,'fieldRequired' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                        ...
                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($passport->country_id == $item->id): ?> selected <?php endif; ?> data-tokens="<?php echo e($item->iso3); ?>" data-content="<span
                            class='flag-icon flag-icon-<?php echo e(strtolower($item->iso)); ?> flag-icon-squared'></span>
                            <?php echo e($item->nationality .' ('.  $item->name . ')'); ?>" value="<?php echo e($item->id); ?>"><?php echo e($item->nationality); ?></option>
...
<script>
    ...
    $('#save-passport-form').click(function(){
        $.easyAjax({
                    url: "<?php echo e(route('passport.update', $passport->id)); ?>",
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/employees/ajax/edit-passport-modal.blade.php ENDPATH**/ ?>