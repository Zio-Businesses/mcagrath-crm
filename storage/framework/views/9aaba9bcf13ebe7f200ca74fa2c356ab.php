<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('app.leavesApproveReason'); ?></h5>
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('app.reason'),'fieldName' => 'approve_reason','fieldId' => 'approve_reason'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-approve-leave']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-approve-leave').click(function() {
        let url = '<?php echo e(route("leaves.leave_action")); ?>';
        let action = '<?php echo e($leaveAction); ?>';
        let leaveId = '<?php echo e($leaveID); ?>';
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/leaves/approve/index.blade.php ENDPATH**/ ?>