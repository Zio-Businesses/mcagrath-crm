<div class="chartHeading-org d-flex justify-content-between mt-3 rounded-top">
    <h3 class="f-21 f-w-500 mb-0"><?php echo app('translator')->get('modules.department.treeView'); ?></h3>
...
<script>
    ...
    var chartValue = [];
    var departmentHierarchy = <?php echo $chartDepartments; ?>;
      ...
      for (var i = 0; i < departmentHierarchy.length; i++) {
        ...
        var chart = JSC.chart('chartDiv', {
          ...
          defaultSeries: {
            ...
            series: [{
                defaultPoint: {
                outline: { color: '#<?php echo e($appTheme->header_color); ?>'},
                color: '#fff',
                },
                points: chartValue,
            }],
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/departments-hierarchy/chart_organization.blade.php ENDPATH**/ ?>