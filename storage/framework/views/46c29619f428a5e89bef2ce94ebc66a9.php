...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-vendor-note-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('Vendor Note Details'); ?></h4>
...
<?php $component->withAttributes([]); ?>
                            ...
                            <?php $__currentLoopData = $notestitle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php if($note->notes_title == $type->notes_title): echo 'selected'; endif; ?> value="<?php echo e($type->notes_title); ?>">
                                            <?php echo e($type->notes_title); ?></option>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'notes','fieldLabel' => __('modules.client.noteDetail'),'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            <div id="details"><?php echo $note->notes_content; ?></div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-vendor-note-form','class' => 'mr-3']); ?><?php echo app('translator')->get('app.save'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-vendor-note-form').click(function() {
            ...
            const url = "<?php echo e(route('vendor-module-notes.update', $note->id)); ?>";
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/vendors/notes/edit.blade.php ENDPATH**/ ?>