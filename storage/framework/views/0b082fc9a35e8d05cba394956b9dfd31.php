...
<?php $component->withAttributes([]); ?>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 text-capitalize" for="usr"><?php echo app('translator')->get('modules.employees.gender'); ?></label>
                <div class="select-filter mb-4">
                    <div class="select-others">
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 text-capitalize" for="usr"><?php echo app('translator')->get('modules.employees.employmentType'); ?></label>
                <div class="select-filter mb-4">
                    <div class="select-others">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/employees/index.blade.php ENDPATH**/ ?>