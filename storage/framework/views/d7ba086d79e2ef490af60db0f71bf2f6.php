         ...
         <div class="minimized rounded bg-additional-grey border-grey mr-3">
             ...
             <div class="d-flex mt-4 mx-1 b-p-header align-items-center">
                 ...
                 <p class="mb-3 mx-0 f-15 text-dark-grey font-weight-bold"><i class="fa fa-circle mb-2 text-red"
                         style="color: <?php echo e($column->label_color); ?>"></i><?php echo e($column->name); ?>

                </p>

                 <span class="b-p-badge bg-grey f-13 px-2 py-2 text-lightest font-weight-bold rounded d-inline-block" id="lead-column-count-<?php echo e($column->id); ?>"><?php echo e($column->deals_count); ?></span>
         ...
         <div class="board-panel rounded bg-additional-grey border-grey mr-3">
             ...
             <div class="mx-3 mt-3 mb-1 b-p-header">
                <div class="d-flex">
                 ...
                 <span
                     class="b-p-badge bg-grey f-13 px-2 text-lightest font-weight-bold rounded d-inline-block ml-1" id="lead-column-count-<?php echo e($column->id); ?>"><?php echo e($column->deals_count); ?></span>
                 ...
                 <span class="ml-auto d-flex align-items-center">
                    ...
                    <?php if($addLeadPermission != 'none' || $manageStatusPermission == 'all'): ?>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                ...
                                <?php if($addLeadPermission != 'none'): ?>
                                    <a class="dropdown-item openRightModal"
                                        href="<?php echo e(route('deals.create')); ?>?column_id=<?php echo e($column->id); ?>"><?php echo app('translator')->get('modules.deal.addDeal'); ?>
                                        </a>
                                <?php endif; ?>
                                <?php if($manageStatusPermission == 'all'): ?>
                                    <hr class="my-1">
                                ...
                                <?php if(!$column->default && $manageStatusPermission == 'all' && $column->slug != 'generated' &&  $column->slug != 'win' && $column->slug != 'lost' ): ?>
                                    <a class="dropdown-item delete-column"
                                        data-column-id="<?php echo e($column->id); ?>" href="javascript:;"><?php echo app('translator')->get('app.delete'); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <div class="mr-3 ml-4 f-11 text-dark-grey"><?php echo e(currency_format($column->total_value, company()->currency_id)); ?></div>
             </div>
             ...
             <div class="b-p-body">
                 ...
                 <div class="b-p-tasks" id="drag-container-<?php echo e($column->id); ?>" data-column-id="<?php echo e($column->id); ?>">
                    <div class="card rounded bg-white border-grey b-shadow-4 m-1 mb-3 no-task-card move-disable <?php echo e((count($column['deals']) > 0) ? 'd-none' : ''); ?>">
                        <div class="card-body">
                            <div class="d-flex justify-content-center py-3">
                                <p class="mb-0">
                                    <a href="<?php echo e(route('deals.create')); ?>?column_id=<?php echo e($column->id); ?>"
                                        class="text-dark-grey openRightModal"><i
                                            class="fa fa-plus mr-2"></i><?php echo app('translator')->get('modules.deal.addDeal'); ?></a>
                                </p>
                            </div>
                        </div>
                    </div><!-- div end -->

                    <?php $__currentLoopData = $column['deals']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = App\View\Components\Cards\LeadCard::resolve(['draggable' => ($changeStatusPermission == 'all') ? 'true' : 'false','lead' => $lead] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
 ...
 <script>
     drake.on('drop', function(element, target, source, sibling) {
         ...
         $.easyAjax({
             url: "<?php echo e(route('leadboards.update_index')); ?>",
             type: 'POST',
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/leads/board/board_data.blade.php ENDPATH**/ ?>