...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'updateMethods','class' => 'ajax-form']); ?>
    <div class="modal-header">
        <h5 class="modal-title"><?php echo app('translator')->get('app.updateofflinePaymentMethod'); ?></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldLabel' => __('modules.offlinePayment.method'),'fieldPlaceholder' => __('placeholders.offlinePayment.method'),'fieldName' => 'name','fieldId' => 'name','fieldValue' => $method->name,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Textarea::resolve(['fieldLabel' => __('modules.offlinePayment.description'),'fieldName' => 'description','fieldId' => 'description','fieldPlaceholder' => __('placeholders.offlinePayment.description'),'fieldValue' => $method->description,'fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Select::resolve(['fieldId' => 'offline_payment_status','fieldLabel' => __('app.status'),'fieldName' => 'status','search' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                            <option value="yes" <?php if($method->status == 'yes'): ?> selected <?php endif; ?>><?php echo app('translator')->get('modules.offlinePayment.active'); ?></option>
                            <option value="no" <?php if($method->status == 'no'): ?> selected <?php endif; ?>><?php echo app('translator')->get('modules.offlinePayment.inActive'); ?></option>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'save-method']); ?><?php echo app('translator')->get('app.save'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    ...
    $('#save-method').click(function () {
        var url =  "<?php echo e(route('offline-payment-setting.update', $method->id)); ?>";
        $.easyAjax({
            url: url,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/payment-gateway-settings/edit-offline-payment-modal.blade.php ENDPATH**/ ?>