                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 active wcform"
                               href="<?php echo e(route('vendor-settings.index')); ?>" role="tab"
                               aria-controls="nav-wcform" aria-selected="true"><?php echo app('translator')->get($pageTitle); ?>
                            </a>

                            <a class="nav-item nav-link f-15 active wostatus"
                               href="<?php echo e(route('vendor-settings.index')); ?>?tab=wostatus" role="tab"
                               aria-controls="nav-wostatus" aria-selected="true"><?php echo app('translator')->get('Work Order Status'); ?>
                            </a>

                            <a class="nav-item nav-link f-15 active sowtitle"
                               href="<?php echo e(route('vendor-settings.index')); ?>?tab=sowtitle" role="tab"
                               aria-controls="nav-sowtitle" aria-selected="true"><?php echo app('translator')->get('Sow Title'); ?>
                            </a>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addWorkOrderStatus','class' => 'wostatus-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Work Order Status'); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'addSOW','class' => 'sowtitle-btn d-none mb-2 actionBtn']); ?> <?php echo app('translator')->get('Add Scope Of Work Title'); ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcf8d12533ff890e0d6573daf32b7618d)): ?>
<?php $attributes = $__attributesOriginalcf8d12533ff890e0d6573daf32b7618d; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\public_html\resources\views/vendor-settings/index.blade.php ENDPATH**/ ?>