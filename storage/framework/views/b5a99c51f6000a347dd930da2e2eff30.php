                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 location-setting"
                               href="<?php echo e(route('app-settings.index')); ?>?tab=location-setting" role="tab"
                               aria-controls="nav-ticketTypes" aria-selected="true"
                               ajax="false"><?php echo app('translator')->get('Location Settings'); ?>
                            </a>
                        </div>
                    </nav>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/app-settings/index.blade.php ENDPATH**/ ?>