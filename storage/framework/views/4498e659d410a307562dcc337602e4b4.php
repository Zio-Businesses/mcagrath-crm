...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'client_id','fieldLabel' => __('modules.deal.title')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    <p class="f-w-500"><?php echo e($proposal->lead->name); ?></p>
                    <input type="hidden" name="deal_id" value="<?php echo e($proposal->deal_id); ?>">
                </div>
            </div>
            <!-- CLIENT END -->
...
<?php endif; ?>
                    <div class="select-others height-35 rounded">
                        <select class="form-control select-picker" data-live-search="true" data-size="8"
                            ...
                            <option value="before_discount" <?php if($proposal->calculate_tax == 'before_discount'): ?> selected <?php endif; ?>>
...
<?php $component->withAttributes(['class' => 'mb-4']); ?>
                    <option <?php if($proposal->status == 'accepted'): ?> selected <?php endif; ?> value="accepted"><?php echo app('translator')->get('modules.proposal.accepted'); ?>
                    </option>
                    <option <?php if($proposal->status == 'waiting'): ?> selected <?php endif; ?> value="waiting"><?php echo app('translator')->get('modules.proposal.waiting'); ?>
                    </option>
                    <option <?php if($proposal->status == 'declined'): ?> selected <?php endif; ?> value="declined"><?php echo app('translator')->get('modules.proposal.declined'); ?>
                    </option>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = App\View\Components\Forms\Checkbox::resolve(['fieldLabel' => __('modules.proposal.requireSignature'),'fieldName' => 'require_signature','fieldId' => 'require_signature','fieldValue' => 'true','checked' => $proposal->signature_approval] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class="d-none d-md-block d-lg-table-row">
                                        ...
                                        <td class="border-left-0">
                                            ...
                                            <?php if($item->proposalItemImage && $item->proposalItemImage->external_link): ?>
                                ...
                                <tr class="d-none d-md-table-row d-lg-table-row">
                                    <td colspan="4" class="dash-border-top bblr">
                                        <textarea class="f-14 border-0 w-100 desktop-description" name="item_summary[]"
                                            placeholder="<?php echo app('translator')->get('placeholders.invoices.description'); ?>"><?php echo e($proposal->note); ?></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <div class="d-flex flex-wrap px-lg-4 px-md-4 px-3 py-3">
            <div class="col-md-6 col-sm-12 c-inv-note-terms p-0 mb-lg-0 mb-md-0 mb-3">
                ...
                <textarea class="form-control" name="note" id="note" rows="4"
                    placeholder="<?php echo app('translator')->get('placeholders.invoices.note'); ?>"><?php echo e($proposal->note); ?></textarea>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        file.on('dropify.beforeClear', function(event, element) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "<?php echo e(route('proposals.delete_image')); ?>";
        ...
        const dp1 = datepicker('#valid_till', {
            position: 'bl',
            dateSelected: new Date("<?php echo e(str_replace('-', '/', $proposal->valid_till)); ?>"),
            ...datepickerConfig
        });
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "<?php echo e(route('proposals.update', $proposal->id)); ?>" + "?type=" + type,
                container: '#saveInvoiceForm',
                type: "POST",
                blockUI: true,
                redirect: true,
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/proposals/ajax/edit.blade.php ENDPATH**/ ?>