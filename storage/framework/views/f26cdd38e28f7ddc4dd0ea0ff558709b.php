                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="form-group mb-lg-0 mb-md-0 mb-4">
                            ...
                            <div class="input-group">
                                <input type="text" name="estimate_number" id="estimate_number" class="form-control height-35 f-15 readonly-background" readonly value="<?php echo e($estimate->estimate_number); ?>" >
                            </div>
                        </div>
                    </div>
                    <!-- INVOICE NUMBER END -->
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'due_date','fieldLabel' => __('modules.estimates.validTill')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                            ...
                            <div class="select-others height-35 rounded">
                                <select class="form-control select-picker" name="currency_id" id="currency_id">
                                    <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($estimate->currency_id == $currency->id): ?> selected <?php endif; ?>
...
<?php endif; ?>
                            <select class="form-control select-picker" name="status" id="status">
                                    <option
                                            <?php if($estimate->status == 'accepted'): ?> selected <?php endif; ?>
                                    value="accepted"><?php echo app('translator')->get('modules.estimates.accepted'); ?>
                                    </option>
                                    <option
                                            <?php if($estimate->status == 'waiting'): ?> selected <?php endif; ?>
                                    value="waiting"><?php echo app('translator')->get('modules.estimates.waiting'); ?>
                                    </option>
                                    <option
                                            <?php if($estimate->status == 'declined'): ?> selected <?php endif; ?>
                                    value="declined"><?php echo app('translator')->get('modules.estimates.declined'); ?>
                                    </option>
                                    <?php if($estimate->status == 'draft'): ?>
                                    <option
                                            <?php if($estimate->status == 'draft'): ?> selected <?php endif; ?>
                                    value="draft"><?php echo app('translator')->get('modules.invoices.draft'); ?>
                                    </option>
                                    <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <select class="form-control select-picker" data-live-search="true" data-size="8" id="add-products">
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                        data-content="<?php echo e($item->name); ?> <a href='javascript:;' class='p-1 badge badge-secondary ml-2'><i class='fa fa-plus mr-1'></i><?php echo e(__('app.add')); ?></a>"
                                ...
                                <tr>
                                    <td class="border-bottom-0 btrr-mbl btlr">
                                        <input type="text" class="f-14 border-0 w-100 item_name" name="item_name[]"
                                            placeholder="<?php echo app('translator')->get('modules.expenses.itemName'); ?>" value="<?php echo e($item->item_name); ?>">
                                    </td>
                                    <td class="border-bottom-0 d-block d-lg-none d-md-none">
                                        <input type="text" class="f-14 border-0 w-100 mobile-description" placeholder="<?php echo app('translator')->get('placeholders.invoices.description'); ?>" name="item_summary[]" value="<?php echo e($item->item_summary); ?>">
                                    </td>
                                    <td class="border-bottom-0">
                                        <input type="number" min="1" class="f-14 border-0 w-100 text-right quantity" value="<?php echo e($item->quantity); ?>"
                                            name="quantity[]">
                                    </td>
                                    <td class="border-bottom-0">
                                        <input type="number" min="1" class="f-14 border-0 w-100 text-right cost_per_item"
                                            placeholder="0.00" value="<?php echo e($item->unit_price); ?>" name="cost_per_item[]">
                                    </td>
                                    <td class="border-bottom-0">
                                    ...
                                    <table width="100%">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="30%" class="border-top-0 sub-total"><?php echo e(number_format((float)$estimate->sub_total, 2, '.', '')); ?></td>
                                                <input type="hidden" class="sub-total-field" name="sub_total" value="<?php echo e($estimate->sub_total); ?>">
                                            </tr>
                                            <tr>
                                                                ...
                                                                <td width="50%" align="left" class="c-inv-sub-padding">
                                                                    <div
                                                                        ...
                                                                        <select class="form-control select-picker"
                                                                            ...
                                                                            <option <?php if($estimate->discount_type == 'percent'): ?> selected <?php endif; ?> value="percent">%</option>
                                                ...
                                                <td><span id="discount_amount"><?php echo e(number_format((float)$estimate->discount, 2, '.', '')); ?></span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr class="bg-amt-grey f-16 f-w-500">
                                                ...
                                                <td><span class="total"><?php echo e(number_format((float)$estimate->total, 2, '.', '')); ?></span></td>
                                                <input type="hidden" class="total-field" name="total" value="<?php echo e(round($estimate->total, 2)); ?>">
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                ...
                <div class="px-lg-4 px-md-4 px-3 py-3 c-inv-btns">
                    ...
                    <button type="button"
                        class="btn-cancel rounded mt-3 mt-lg-0 mt-md-0 mr-0 mr-lg-3 mr-md-3 f-15"><?php echo app('translator')->get('app.cancel'); ?></button>
                ...
                +'<table width="100%">'
                    +'<tbody>'
                        +'<tr class="text-dark-grey font-weight-bold f-14">'
                            ...
                            +'<tr>'
                                +'<td class="border-bottom-0 btrr-mbl btlr">'
                                    +`<input type="text" class="f-14 border-0 w-100 item_name" name="item_name[]" placeholder="<?php echo app('translator')->get('modules.expenses.itemName'); ?>">`
                                    +'</td>'
                                    +'<td class="border-bottom-0 d-block d-lg-none d-md-none">'
                                        +`<input type="text" class="f-14 border-0 w-100 mobile-description" name="item_summary[]" placeholder="<?php echo app('translator')->get('placeholders.invoices.description'); ?>">`
                                    +'</td>'
                                    +'<td class="border-bottom-0">'
                                        ...
                                        +'<td class="border-bottom-0">'
                                            ...
                                            +'<td class="border-bottom-0">'
                                                +'<div class="select-others height-35 rounded border-0">'
                                                    ...
                                                    <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        +'<option data-rate="<?php echo e($tax->rate_percent); ?>" data-tax-text="<?php echo e($tax->tax_name .':'. $tax->rate_percent); ?>%" value="<?php echo e($tax->id); ?>"><?php echo e($tax->tax_name); ?>: <?php echo e($tax->rate_percent); ?>%</option>'
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    +'</select>'
                                                +'</div>'
                                            +'</td>'
                            ...
                            +'<tr class="d-none d-md-table-row d-lg-table-row">'
                                +'<td colspan="4" class="dash-border-top bblr">'
                                    +'<input type="text" class="f-14 border-0 w-100 desktop-description" name="item_summary[]" placeholder="<?php echo app('translator')->get('placeholders.invoices.description'); ?>">'
                                +'</td>'
                            +'</tr>'
                        +'</tbody>'
                    +'</table>'
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/recurring-expenses/edit.blade.php ENDPATH**/ ?>