<div class="modal-header">
    <h5 class="modal-title" id="modelHeading"><?php echo app('translator')->get('modules.estimates.signatureAndConfirmation'); ?></h5>
...
<?php $component = App\View\Components\Forms\Text::resolve(['fieldId' => 'full_name','fieldLabel' => __('app.name'),'fieldName' => 'full_name','fieldRequired' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\Label::resolve(['fieldId' => 'signature-pad','fieldLabel' => __('modules.estimates.signature'),'fieldRequired' => $proposal->signature_approval ? true : false] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Forms\File::resolve(['allowedFileExtensions' => 'png jpg jpeg svg bmp','fieldLabel' => __('modules.estimates.signature'),'fieldName' => 'image','fieldId' => 'image','popover' => __('messages.fileFormat.ImageFile'),'fieldRequired' => $proposal->signature_approval ? true : false] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ml-2 signature','id' => 'clear-signature']); ?><?php echo app('translator')->get('modules.estimates.clear'); ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad)): ?>
<?php $attributes = $__attributesOriginal5e57c6582b8a883148a28bb7ee46d2ad; ?>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/proposals/ajax/accept-proposal.blade.php ENDPATH**/ ?>