...
<?php $component->withAttributes(['id' => 'save-timelog-data-form']); ?>
            ...
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.timeLogDetails'); ?></h4>
                <div class="row p-20">
                    <div class="col-md-12">
                        <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $('#project_id2').change(function() {
            ...
            var url = "<?php echo e(route('tasks.project_tasks', ':id').'?for_timelogs=true'); ?>";
        ...
        function calculateTime() {
            ...
            var timeFormat = '<?php echo e(company()->time_format); ?>';
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/timelogs/ajax/edit.blade.php ENDPATH**/ ?>