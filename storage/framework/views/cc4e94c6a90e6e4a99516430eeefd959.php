...
<div id="container">
    <div class="invoice-top">
        ...
        <section id="invoice-info">
            <table>
                <tr>
                    <td><?php echo app('translator')->get('app.issuesDate'); ?>:</td>
                    <td><?php echo e($creditNote->issue_date->translatedFormat(company()->date_format)); ?></td>
                </tr>
                <?php if($invoiceNumber): ?>
                    <tr>
                        <td><?php echo app('translator')->get('app.invoiceNumber'); ?>:</td>
                        <td><?php echo e($invoiceNumber->invoice_number); ?></td>
                    </tr>
                <?php endif; ?>
                <tr>
                    <td><?php echo app('translator')->get('app.status'); ?>:</td>
                    <td><?php echo e($creditNote->status); ?></td>
                </tr>
            </table>
            ...
            <div id="invoice-title-number">
                ...
                <span id="number"><?php echo e($creditNote->cn_number); ?></span></p>

            </div>
        </section>
        <?php if(!is_null($creditNote->project) && !is_null($creditNote->project->client)): ?>
            <section id="client-info">
                <?php if(!is_null($creditNote->project->client)): ?>
                    <span><?php echo app('translator')->get('modules.credit-notes.billedTo'); ?>:</span>
                    <div>
                    ...
                    <div>
                        <span><?php echo e($creditNote->project->client->email); ?></span>
                    </div>
                ...
                <br>
                <span class="text-dark-grey text-capitalize"><?php echo app('translator')->get("modules.invoices.projectName"); ?>:</span>
                <?php echo e($creditNote->project->project_name); ?>

                <?php endif; ?>
            </section>
        <?php elseif(is_null($creditNote->project) && !is_null($creditNote->client->clientDetails)): ?>
            <section id="client-info">
                <?php if(!is_null($creditNote->client)): ?>
                    <span><?php echo app('translator')->get('modules.credit-notes.billedTo'); ?>:</span>
                    <div>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <?php if(($invoiceSetting->show_project == 1) && (isset($creditNote->client))): ?>
                    <br>
                    <span class="text-dark-grey text-capitalize"><?php echo app('translator')->get("modules.invoices.projectName"); ?>:</span>
                    <?php echo e($creditNote->project->project_name); ?>
    ...
    <div class="invoice-body">
        <section id="items">
                ...
                <tr data-iterate="item">
                    ...
                    <td class="word-break">
                        ...
                        <?php if($item->creditNoteItemImage): ?>
                            <p class="mt-2">
                                <img src="<?php echo e($item->creditNoteItemImage->file_url); ?>" width="60" height="60" class="img-thumbnail">
                            </p>
                        <?php endif; ?>
                    </td>
                    <?php if($invoiceSetting->hsn_sac_code_show): ?>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="<?php echo e($creditNoteSetting->hsn_sac_code_show ? '5': '4'); ?>"><?php echo app('translator')->get("modules.credit-notes.subTotal"); ?>:</td>
                    <td><?php echo e(currency_format($creditNote->sub_total, $creditNote->currency_id, false)); ?></td>
                </tr>
                <?php if($discount != 0 && $discount != ''): ?>
                <tr data-iterate="tax">
                    <td colspan="<?php echo e($creditNoteSetting->hsn_sac_code_show ? '5': '4'); ?>"><?php echo app('translator')->get("modules.credit-notes.discount"); ?>:</td>
                ...
                <tr data-iterate="tax">
                    <td colspan="<?php echo e($creditNoteSetting->hsn_sac_code_show ? '5': '4'); ?>"><?php echo e($key); ?>:</td>
                    <td><?php echo e(currency_format($tax, $creditNote->currency_id, false)); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <tr class="amount-total">
                    <td colspan="<?php echo e($creditNoteSetting->hsn_sac_code_show ? '5': '4'); ?>"><?php echo app('translator')->get("modules.credit-notes.total"); ?>:</td>
                    <td><?php echo e(currency_format($creditNote->total, $creditNote->currency_id, false)); ?></td>
                </tr>
                <tr>
                    <td colspan="<?php echo e($creditNoteSetting->hsn_sac_code_show ? '5': '4'); ?>"><?php echo app('translator')->get("modules.credit-notes.creditAmountUsed"); ?>:</td>
                    <td><?php echo e(currency_format($creditNote->creditAmountUsed(), $creditNote->currency_id, false)); ?></td>
                </tr>
                <tr>
                    <td colspan="<?php echo e($creditNoteSetting->hsn_sac_code_show ? '5': '4'); ?>"><?php echo app('translator')->get('app.adjustmentAmount'); ?>:</td>
                    <td><?php echo e(currency_format($creditNote->adjustment_amount, $creditNote->currency_id, false)); ?></td>
                </tr>
                <tr>
                    <td colspan="<?php echo e($creditNoteSetting->hsn_sac_code_show ? '5': '4'); ?>">
        ...
        <section id="terms">
            <?php if(!is_null($creditNote->note)): ?>
                <div class="word-break item-summary"><?php echo nl2br($creditNote->note); ?></div>
            <?php endif; ?>

            <div class="word-break item-summary"><?php echo nl2br($creditNoteSetting->invoice_terms); ?></div>
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/credit-notes/pdf/invoice-2.blade.php ENDPATH**/ ?>