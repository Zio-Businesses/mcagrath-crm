...
<body class="content-wrapper">
    <h3 class="text-center"><?php echo app('translator')->get('app.paymentReceipt'); ?></h3>
    ...
    <table class="f-14 b-collapse" width="100%">
        ...
        <tr class="main-table-items">
            ...
            <td ><?php echo e(currency_format($payment->amount, $payment->currency_id)); ?> <?php echo e(($payment->currency ? $payment->currency->currency_code : company()->currency->currency_code)); ?></td>
        </tr>
        <tr class="main-table-items">
...
<?php /**PATH /home/u659716913/domains/crm.mcresi.com/public_html/resources/views/payments/ajax/pdf.blade.php ENDPATH**/ ?>