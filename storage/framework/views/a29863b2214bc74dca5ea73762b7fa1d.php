...
<?php $component->withAttributes([]); ?>
                            <select class="form-control select-picker" name="company_type" id="company_type" data-live-search="true">
                                ...
                                <?php $__currentLoopData = $companyTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $companyType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($companyType->type); ?>"><?php echo e($companyType->type); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php $component->withAttributes([]); ?>
                            <select class="form-control select-picker" name="status_type" id="status_type" data-live-search="true">
                                ...
                                <?php $__currentLoopData = $statusLeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusLead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($statusLead->status); ?>"><?php echo e($statusLead->status); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                             <?php $__env->slot('append', null, []); ?> 
...
<script>
    $(document).ready(function() {
        ...
        const url = "<?php echo e(route('company-types.create')); ?>";
        $.ajaxModal(MODAL_LG, url);
        });
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views/lead-contact/ajax/create.blade.php ENDPATH**/ ?>