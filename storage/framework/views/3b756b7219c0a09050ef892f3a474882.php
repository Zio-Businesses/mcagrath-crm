...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'add-consent','class' => 'mr-3 float-left mb-2 mb-lg-0 mb-md-0']); ?>
                <?php echo app('translator')->get('app.menu.addConsent'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="row">
        <?php echo $dataTable->table(['class' => 'table table-hover border-0 w-100 table-sm-responsive']); ?>
...
<script>
    ...
    $('body').on('click', '.delete-table-row', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "<?php echo e(route('gdpr_settings.purpose_delete', ':id')); ?>";
    ...
    const applyQuickAction = () => {
        ...
        const url = "<?php echo e(route('gdpr_settings.apply_quick_action')); ?>?row_ids=" + rowdIds;
    ...
    $(body).on('click', '#add-consent', function() {
        const url = "<?php echo e(route('gdpr.add_consent')); ?>";
    ...
    $(body).on('click', '.edit-consent', function() {
        ...
        var url = "<?php echo e(route('gdpr.edit_consent', ':id')); ?>";
...
<?php /**PATH C:\laragon\www\mcagrath-crm\resources\views\gdpr-settings\ajax\consent-lists.blade.php ENDPATH**/ ?>