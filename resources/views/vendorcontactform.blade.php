                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-forms.text :fieldLabel="__('app.website')" fieldName="website"
                            fieldId="website"  fieldRequired="true" />
                    </div>
            
                    <!-- logo -->
                    <div class="col-lg-12">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.logo')" fieldName="logo"
                            fieldId="logo" :popover="__('messages.fileFormat.multipleImageFile')" fieldRequired="true" />
                    </div>
                    <!-- co type select -->
                    <!-- <div class="col-lg-4 col-md-6">
                        <x-forms.text :fieldLabel="__('app.company_name')" fieldName="company_name"
                        ...
                        <div class="form-group my-3">
                            ...
                            <div class="d-flex">
                                ...
                                <x-forms.radio fieldId="lic-no" :fieldLabel="__('app.no')" fieldValue="no"
                                    fieldName="licensed" checked="true"></x-forms.radio>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-forms.text :fieldLabel="__('app.license')" fieldName="license"
                            fieldId="license"  fieldRequired="true" />
                    </div>
                    <div class="col-lg-4 col-md-6">
                    ...
                    <div class="form-group my-3">
                            ...
                            <div class="d-flex">
                                ...
                                <x-forms.radio fieldId="in-no" :fieldLabel="__('app.no')" fieldValue="no"
                                    fieldName="insured" checked="true"></x-forms.radio>
                    ...
                    <div class="form-group my-3">
                            ...
                            <div class="d-flex">
                                ...
                                <x-forms.radio fieldId="wc-no" :fieldLabel="__('app.no')" fieldValue="no"
                                    fieldName="wca" checked="true"></x-forms.radio>
