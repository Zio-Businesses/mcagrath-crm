...
<head>
    ...
    @includeIf('estimates-vendor.pdf.estimate_pdf_css')
    <style>
        .bg-grey {
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="f-14 text-black">
                                ...
                                {{ $estimate->vendors->vendor_name}}<br>
                                {{ $estimate->vendors->vendor_email }}<br>
                                {{ $estimate->vendors->cell }}<br>
                                {{ $estimate->vendors->company_name }}<br>
                                {{$estimate->vendors->street_address}}
                                </p>
                            </td>

                            <td align="right">
                                <br />
                                @if ($estimate->vendors->company_logo)
                                    <img src="{{ $estimate->vendors->image_url }}"
                                        alt="{{ $estimate->vendors->company_name }}" class="logo"
                                        style="height:50px;" />
                                    <br><br><br>
                                @endif
                            </td>
