                        ...
                        <div class="select-others height-35 rounded">
                            <select class="form-control select-picker" data-live-search="true" data-size="8"
                                ...
                                @foreach ($projects as $item)
                                    <option  @selected ($item->id == $estimate->project_id) value="{{ $item->id }}">{{ $item->project_short_code }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group c-inv-select mb-4">
                    ...
                    <div class="select-others height-35 rounded">
                        <select class="form-control select-picker" data-live-search="true" data-size="8"
                            ...
                            <option value="">--</option>
                            @foreach ($estimate->project->projectvendor->unique('vendor_id') as $item)
                                <option @if ($estimate->vendor_id == $item->vendor_id) selected @endif value="{{ $item->vendor_id }}">
                            ...
                            <tr>
                                <td class="border-bottom-0 btrr-mbl btlr">
                                    <input type="text" class="f-14 border-0 w-100 item_name form-control"
                                        name="item_name[]" placeholder="@lang('modules.expenses.itemName')" value="{{ $item->item_name }}">
                                </td>
...
<script>
    $(document).ready(function() {
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "{{ route('vendor-estimates.update', $estimate->id) }}",
